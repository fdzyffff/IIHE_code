...
void my_BW(Double_t mass, Double_t M, Double_t width, Double_t gaB, Double_t PS_mass, Double_t PS_M, Double_t &re, Double_t &im, bool changeGamma = false);
...
Double_t my_cs_hc(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   my_BW(mass,M1,width1,gaB1,ps3_mass,ps3_M1, re1, im1, true);
...
Double_t my_cs_omega(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   //printf("mass : %f\n",mass );
   my_BW(mass,M1,width1,gaB3,ps2_mass,ps2_M1, re3, im3, true);
   //printf("after bw : %f  ; %f\n",re3, im3 );
   tt = CC*sqrt(ps2_mass);
   //tt = 0;
...
Double_t my_cs_jpsi(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   my_BW(mass,M1,width1,gaB4,ps3_mass,ps3_M1, re4, im4, true);// 4: Y(4220)
...
Double_t my_cs_ddpi(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   //ps3_M2 = 1;
   //printf("PS_mass : %f ; PS_M1 : %f ; PS_M5 : %f\n",ps3_mass,ps3_M1,ps3_M5 );
   my_BW(mass,M1,width1,gaB7,ps3_mass,ps3_M1, re7, im7, true);// 4: Y(4220)
