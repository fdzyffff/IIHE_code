...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.057, 0.6, 4.393, 0.154, 1.3, -1.2, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4, 0, 0, 0, 0};//new data pipihc result 2
