...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.34, 0.66 , 4.33 , 0.1 , 1.3 , 0.35, 0.8, -2.0, 1500.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 2
   ...
   gMinuit->mnparm( 1, "width(4220)"      , para[1], para_step[1], 0.03, 0.15, ierflg);//4220
   ...
   gMinuit->mnparm( 20, "gaB_ddpi(4220)"        , para[20], para_step[20], 0.1, 50, ierflg);//
   gMinuit->mnparm( 21, "gaB_ddpi(4390)"        , para[21], para_step[21], 0.1, 50, ierflg);//
