...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.222 , 0.057, 0.43, 4.416, 0.165, 1.32, 3.2, 0.0, 0.0, 0.35, 3.869, 0.3, 0.6 , 4.385 , 0.25 , 3.5 , 1.6, -1.4 ,-3.1, 1430.85, 0.687, 5.192, 2.52, 2.7, 0, 0, 0, 0};//new data jpsi result 4
   ...
   gMinuit->mnparm( 13, "M(4320)"         , para[13], para_step[13], 4.2, 4.6, ierflg);//
