...
Double_t my_cs_jpsi(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   re5 = (10000*p0*exp(-1.0*p1*(mass - (m1 + m2 + m3))));
   re5 = sqrt(re5)*sqrt(ps3_mass);
...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.16, 3.01, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.34 , 0.06 , 0.055 , 0.18, 0.66, 2.82, 1362.6, 0.53, 3.97, 2.16, 1.92, 205.0, 4.1, 0.0, 0};//Default result
   //Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.2, 3.1, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.3 , 0.07 , 0.01 , 0.26, 0.32, 4.23, 2000.0, 7.2, 5.9, -2.2, 2.4,  205.0, 4.5, 0.0, 0};//new data ddpi result 2
   //Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.2, 3.1, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.3 , 0.07 , 0.01 , 0.26, 0.32, 4.23, 2000.0, 2.9, 26.0, -2.2, 4.2, 205.0, 4.5, 0.0, 0};//new data ddpi result 3
   Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.2, 3.1, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.3 , 0.07 , 0.01 , 0.26, 0.32, 4.23, 2000.0, 8.4, 35.0, -1.4, 3.94,205.0, 4.5, 0.0, 0};//new data ddpi result 4

   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7,  205.0, 4.1, 0.0, 0};//new data jpsi result 2
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.12 , 0.1 , 0.9 , -2.0 ,1.0, 2000.0, 2.5, 4.36, 3.2, 2.7,  205.0, 4.1, 0.0, 0};//new data jpsi result 3
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.11 , 1.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7,  205.0, 4.1, 0.0, 0};//new data jpsi result 4

   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2,205.0, 4.1, 0.0, 0};//new data pipihc result 2
   
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2,205.0, 4.1, 0.0, 0};//new data omega result 2
   ...
   gMinuit->mnparm( 24, "p0"       , para[24], para_step[24], 0, 10000, ierflg);//
