...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 0, 0, 0, 0};//Default result
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4, 0, 0, 0, 0};//new data ddpi result 2
   Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 2.9, 26.0, -2.2, 4.2, 0, 0, 0, 0};//new data ddpi result 3
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 8.4, 35.0, -1.4, 3.94, 0, 0, 0, 0};//new data ddpi result 4

   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 2
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.12 , 0.1 , 0.9 , -2.0 ,1.0, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 3
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.11 , 1.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 4

   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4, 0, 0, 0, 0};//new data pipihc result 2
   
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 9.0, 2.3, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4, 0, 0, 0, 0};//new data omega result 2
