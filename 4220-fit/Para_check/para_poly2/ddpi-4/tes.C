...
void fcn(Int_t &npar, Double_t *gin, Double_t &f, Double_t *par, Int_t iflag)
{
   ...
   //printf("likelihood3 : %f\n",likelihood_3 );
   //printf("likelihood4 : %f\n",likelihood_4 );
...
Double_t my_cs_jpsi(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   Double_t phase_4     = par_list[17];
   Double_t phase_6     = par_list[18];
   Double_t p0   	= par_list[24];    
   Double_t p1   	= par_list[25];
   Double_t p2   	= par_list[26];
   ...
   re5 = (p0+ mass*p1 + mass*mass*p2);
   Double_t check_low = p0+ 3.8*p1 + 3.8*3.8*p2;
   Double_t check_high = p0 + 4.6*p1 + 4.6*4.6*p2;
   if (check_low < 0 || check_high <0 || p2>0)re5=10000;
   re5 = sqrt(re5);
   //printf("mass : %f  ;  re5 : %f ; p0 : %f  ;  p1 : %f  ;  p2 : %f\n",mass,re5,p0,p1,p2 );
   im5 = 0;
   ...
   crossSection=(pow(re,2)+pow(im,2))*(0.389379*10);
   //printf("mass : %f ; re5 : %f ; Xsec : %f\n",mass,re5,crossSection );
...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.16, 3.01, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.34 , 0.06 , 0.055 , 0.18, 0.66, 2.82, 1362.6, 0.53, 3.97, 2.16, 1.92, -108.9953, 57.32, -7.236, 0};//Default result
   //Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.2, 3.1, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.3 , 0.07 , 0.01 , 0.26, 0.32, 4.23, 2000.0, 7.2, 5.9, -2.2, 2.4,    -107.057, 59.70, -7.88, 0};//new data ddpi result 2
   //Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.2, 3.1, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.3 , 0.07 , 0.01 , 0.26, 0.32, 4.23, 2000.0, 2.9, 26.0, -2.2, 4.2,   -107.057, 59.70, -7.88, 0};//new data ddpi result 3
   Double_t para[28] = {4.22 , 0.059, 0.4, 4.39, 0.153, 1.2, 3.1, 0.0, 0.0, 0.34, 3.86, 0.31, 0.55 , 4.3 , 0.07 , 0.01 , 0.26, 0.32, 4.23, 2000.0, 8.4, 35.0, -1.4, 3.94,  -107.057, 59.70, -7.88, 0};//new data ddpi result 4

   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7,  -107.057, 59.70, -7.88, 0};//new data jpsi result 2
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.12 , 0.1 , 0.9 , -2.0 ,1.0, 2000.0, 2.5, 4.36, 3.2, 2.7,  -107.057, 59.70, -7.88, 0};//new data jpsi result 3
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.11 , 1.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7,  -107.057, 59.70, -7.88, 0};//new data jpsi result 4

   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2,  -107.057, 59.70, -7.88, 0};//new data pipihc result 2
   
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.3, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2,  -107.057, 59.70, -7.88, 0};//new data omega result 2

   Double_t para_step[28] = {0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.001, 0.1, 0.01, 0.01, 0.001, 0.001, 0.01, 0.001, 0.001, 0.01, 0.01, 0.01, 0.01, 1, 0.01, 0.01, 0.01, 0.01, 0.1, 0.1, 0.1, 0.01};
   ...
   gMinuit->mnparm( 10, "M(4008)"         , para[10], para_step[10], 3.65, 4.2, ierflg);
   gMinuit->mnparm( 11, "width(4008)"     , para[11], para_step[11], 0.15, 0.7, ierflg);
   gMinuit->mnparm( 12, "gaB(4008)"       , para[12], para_step[12], 0, 5, ierflg);//
   gMinuit->mnparm( 13, "M(4320)"         , para[13], para_step[13], 4.2, 4.5, ierflg);//
   ...
   gMinuit->mnparm( 20, "gaB_ddpi(4220)"        , para[20], para_step[20], 0.0, 50, ierflg);//
   gMinuit->mnparm( 21, "gaB_ddpi(4390)"        , para[21], para_step[21], 0.0, 50, ierflg);//
   ...
   gMinuit->mnparm( 24, "p0"       , para[24], para_step[24], 0, 0, ierflg);//
   gMinuit->mnparm( 25, "p1"       , para[25], para_step[25], 0, 0, ierflg);//

   gMinuit->mnparm( 26, "p2"       , para[26], para_step[26], -10, -3, ierflg);//
   gMinuit->mnparm( 27, "no_use"     , para[27], para_step[27], 0, 0, ierflg);//
