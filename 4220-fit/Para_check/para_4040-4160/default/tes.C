...
Double_t my_cs_jpsi(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   Double_t M10    	 = par_list[24];
   Double_t width10 	 = par_list[25];
   Double_t gaB10   	 = par_list[26];
   Double_t phase_10     = par_list[27];
   ...
   re=re5+re4*cos(phase_4)-im4*sin(phase_4)+re6*cos(phase_6)-im6*sin(phase_6)+re10*cos(phase_10)-im10*sin(phase_10);
   im=im5+im4*cos(phase_4)+re4*sin(phase_4)+im6*cos(phase_6)+re6*sin(phase_6)+im10*cos(phase_10)+re6*sin(phase_10);
...
void my_plot_jpsi(Double_t *par_list)
{
   ...
   gr_jpsi_fit_part4->SetLineWidth(3);
...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 4.039, 0.08, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 4191, 0.07, 0, 0};//Default result
   ...
   gMinuit->mnparm( 24, "M(4160)"     		, para[24], para_step[24], 0, 0, ierflg);//
   gMinuit->mnparm( 25, "width(4160)"  		, para[25], para_step[25], 0, 50, ierflg);//
   gMinuit->mnparm( 26, "gaB_jpsi(4160)"        , para[26], para_step[26], 0, 50, ierflg);//
   gMinuit->mnparm( 27, "phase_jpsi(4160)"      , para[27], para_step[27], 0, 0, ierflg);//
