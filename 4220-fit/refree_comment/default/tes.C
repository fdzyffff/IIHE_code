...
void my_plot_hc(Double_t *par_list)
{
   ...
   TPaveText* tText_1=new TPaveText(0.67,0.7,0.85,0.95,"blNDC");
   tText_1->SetBorderSize(0);
   tText_1->SetFillStyle(0);
   tText_1->SetTextAlign(12);
   tText_1->SetTextColor(1);
   tText_1->SetTextFont(132);
   tText_1->SetTextSize(0.12);
   tText_1->AddText ("Sol. I");
   tText_1->Draw();
...
void my_plot_ps3()
{
   ...
   gr_hc_fit->GetXaxis()->SetRangeUser(4.0,5.0);
   gr_hc_fit->Draw("APC");
   c10->Update();
   c10->Print("4220-pipihc-ps3.eps");
}
