...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.2205, 0.055, 0.2625, 4.3788, 0.147, 0.882, 2.23, 0.0, 0.0, 0.3379, 3.833, 0.359, 0.547, 4.339, 0.116, 0.68, 0.24, 0.144, 2.35, 1436.0, 0.7, 10.6, -1.7, 3.7, 0.0, 0.0, 30.4, -0.9};//Default result 6
   ...
   gMinuit->mnparm( 26, "gaB_ddpi(4320)"       , para[26], para_step[26], 0.1, 150, ierflg);//
