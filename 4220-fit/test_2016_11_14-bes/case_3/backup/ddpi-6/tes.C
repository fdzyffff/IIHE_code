...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.22 , 0.057, 0.2, 4.38, 0.15, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.36, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 8.4, 35.0, -1.4, 3.94, 0.0, 0.0, 0.1, 0.7};//new data ddpi result 6
