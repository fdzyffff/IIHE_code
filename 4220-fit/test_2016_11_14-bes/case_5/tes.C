...
Double_t my_cs_jpsi(Double_t mass, Double_t *par_list, bool my_write)
{
   ...
   my_BW(mass,M2,width2,gaB6,ps3_mass,ps3_M2, re6, im6);// 6: Y(4320)
...
void my_plot_hc(Double_t *par_list)
{
   ...
   gr_hc_data->GetXaxis()->SetTitleSize(0.06);
   gr_hc_data->GetXaxis()->SetTitleOffset(0.9);
   ...
   gr_hc_data->GetYaxis()->SetTitleSize(0.06);
   gr_hc_data->GetYaxis()->SetTitleOffset(0.9);
   gr_hc_data->GetYaxis()->SetRangeUser(-20,110);
   gr_hc_data->Draw("AP");
   ...
   gr_hc_data_scan->SetMarkerColor(46);
   gr_hc_data_scan->SetLineColor(46);
   gr_hc_data_scan->SetLineStyle(1);
   gr_hc_data_scan->SetLineWidth(1);
   gr_hc_data_scan->SetMarkerStyle(20);
...
void my_plot_omega(Double_t *par_list)
{
   ...
   gr_omega_data->GetXaxis()->SetTitleSize(0.06);
   gr_omega_data->GetXaxis()->SetTitleOffset(0.9);
   gr_omega_data->GetXaxis()->SetNdivisions(505);
   gr_omega_data->GetXaxis()->SetRangeUser(4.19,4.7);
   gr_omega_data->GetYaxis()->SetLabelSize(0.06);
   gr_omega_data->GetYaxis()->SetTitle("#sigma (e^{+}e^{-}->#omega#chi_{c0}) (pb)");
   gr_omega_data->GetYaxis()->SetTitleSize(0.06);
   gr_omega_data->GetYaxis()->SetTitleOffset(0.9);
   ...
   legend->SetTextSize(0.06);
   //legend->AddEntry(H_divide,"efficience of HLT_Ele20WP60_Ele8_Mass55_v1 ","l");
   legend->AddEntry(gr_omega_data,"Data ","lp");
   legend->AddEntry(gr_omega_fit,"Best fit ","lp");
   //NameAxes(eff, "Number of pile up)", "Efficience");
   legend->Draw();
   c2->Update();

   c2->Print("4220_omega.png");
   c2->Print("4220_omega.eps");
}
...
void my_plot_jpsi(Double_t *par_list)
{
   ...
   gr_jpsi_data->GetXaxis()->SetTitleSize(0.06);
   ...
   gr_jpsi_data->GetYaxis()->SetTitleSize(0.06);
   gr_jpsi_data->GetYaxis()->SetTitleOffset(1);
   //gr_jpsi_data->GetYaxis()->SetRangeUser(0,140);
   ...
   gr_jpsi_data_scan->SetMarkerColor(46);
   gr_jpsi_data_scan->SetLineColor(46);
   gr_jpsi_data_scan->SetLineStyle(1);
   gr_jpsi_data_scan->SetLineWidth(1);
   gr_jpsi_data_scan->SetMarkerStyle(20);
   ...
   legend->SetTextSize(0.06);
   //legend->AddEntry(H_divide,"efficience of HLT_Ele20WP60_Ele8_Mass55_v1 ","l");
   legend->AddEntry(gr_jpsi_data,"Data ","lp");
   legend->AddEntry(gr_jpsi_fit,"Best fit ","lp");
   //NameAxes(eff, "Number of pile up)", "Efficience");
   legend->Draw();
   c3->Update();

   c3->Print("4220_jpsi.png");
   c3->Print("4220_jpsi.eps");
}
...
void my_plot_ddpi(Double_t *par_list)
{
   ...
   gr_ddpi_data->GetXaxis()->SetLabelSize(0.06);
   gr_ddpi_data->GetXaxis()->SetTitleSize(0.06);
   ...
   gr_ddpi_data->GetYaxis()->SetTitleSize(0.06);
   gr_ddpi_data->GetYaxis()->SetTitleOffset(1);
   //gr_ddpi_data->GetYaxis()->SetRangeUser(-1,1000);
   ...
   gr_ddpi_data_scan->SetMarkerColor(46);
   gr_ddpi_data_scan->SetLineColor(46);
   gr_ddpi_data_scan->SetLineStyle(1);
   gr_ddpi_data_scan->SetLineWidth(1);
   gr_ddpi_data_scan->SetMarkerStyle(20);
   ...
   c4->Update();
   TLegend* legend = new TLegend(0.17, 0.72, 0.32, 0.88) ;
   legend->SetFillColor(kWhite) ;
   legend->SetBorderSize(0) ;
   legend->SetShadowColor(0) ;
   legend->SetTextSize(0.06);
   //legend->AddEntry(H_divide,"efficience of HLT_Ele20WP60_Ele8_Mass55_v1 ","l");
   legend->AddEntry(gr_ddpi_data,"Data ","lp");
   legend->AddEntry(gr_ddpi_fit,"Best fit ","lp");
   //NameAxes(eff, "Number of pile up)", "Efficience");
   legend->Draw();
   c4->Update();

   c4->Print("4220_ddpi.png");
   c4->Print("4220_ddpi.eps");
}
...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.221 , 0.054, 0.216, 4.398, 0.141, 0.449, 2.274, -9.9, 1.087, 0.459, 3.861, 0.302, 0.547 , 4.325 , 0.07 , 0.073 , 0.254, 0.091, 1.882, 1437.0, 0.471, 3.774, 2.31, 2.001, 0, 0, 0, 0};//Default result
   Double_t para[28] = {4.223 , 0.057, 0.401, 4.393, 0.154, 1.6, 3.1, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 0, 0, 0, 0};//Default result

   //Double_t para[24] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4};//new data ddpi result 2
   //Double_t para[24] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 2.9, 26.0, -2.2, 4.2};//new data ddpi result 3
   //Double_t para[24] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 8.4, 35.0, -1.4, 3.94};//new data ddpi result 4



   //Double_t para[19] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7};//new data jpsi result 2
   //Double_t para[19] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.2 , 0.9 , -2.0 ,1.0, 2000.0, 2.5, 4.36, 3.2, 2.7};//new data jpsi result 3
   //Double_t para[19] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 2.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7};//new data jpsi result 4

   //Double_t para[19] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, -0.9, 0.27, 3.83, 0.31,, 0.6 , 4.33 , 0.14 , 0.1 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7};//new data omega result 2

   //Double_t para[19] = {4.22 , 0.05, 0.26, 4.38, 0.137, 0.83, 2.24, -10.0, 1.05, 0.5, 3.83, 0.31,, 0.6 , 4.33 , 0.14 , 0.1 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7};//new data hc result 2




   Double_t para_step[28] = {0.001, 0.001, 0.01, 0.001, 0.001, 0.01, 0.01, 0.1, 0.01, 0.01, 0.001, 0.001, 0.01, 0.001, 0.001, 0.01, 0.01, 0.01, 0.01, 1, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01, 0.01};
   ...
   gMinuit->mnparm( 12, "gaB(4008)"       , para[12], para_step[12], 0, 5, ierflg);//
   ...
   gMinuit->mnparm( 15, "gaB_jpsi(4390)"       , para[15], para_step[15], 0, 5, ierflg);//
   ...
   gMinuit->mnparm( 18, "phase_jpsi_(4390)"    , para[18], para_step[18], 0, 0, ierflg);//

   gMinuit->mnparm( 19, "CC_ddpi"               , para[19], para_step[19], 1000, 3000, ierflg);//constant for PS3 in DDpi
   gMinuit->mnparm( 20, "gaB_ddpi(4220)"        , para[20], para_step[20], 0, 50, ierflg);//
   gMinuit->mnparm( 21, "gaB_ddpi(4390)"        , para[21], para_step[21], 0, 50, ierflg);//
   ...
   gMinuit->mnparm( 24, "gaB_hc(4320)"       , para[24], para_step[24], 0, 50, ierflg);//
   gMinuit->mnparm( 25, "phase_hc(4320)"     , para[25], para_step[25], 0, 0, ierflg);//

   gMinuit->mnparm( 26, "gaB_ddpi(4320)"       , para[26], para_step[26], 0, 50, ierflg);//
