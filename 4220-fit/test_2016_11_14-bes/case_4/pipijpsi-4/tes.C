...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.36, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 0.22, 1.3, 0.8, 3.7};//Default result
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.36, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4, 0.22, 1.3, 0.8, 3.7};//new data ddpi result 2
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.36, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 2.9, 26.0, -2.2, 4.2, 0.22, 1.3, 0.8, 3.7};//new data ddpi result 3
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.334, 3.832, 0.358, 0.541, 4.336, 0.113, 0.072, 0.231, 0.158, 2.284, 1349.2, 0.5, 30.0, 3.826, -1.884, 0.22, 1.3, 1.3, -0.5};//new data ddpi result 4
   //Double_t para[28] = {4.222, 0.051, 0.184, 4.405, 0.146, 0.309, 2.384, 0.0, 0.0, 0.322, 3.844, 0.328, 0.508, 4.318, 0.093, 0.087, 0.202, 0.268, 1.872, 1522.8, 0.68, 40.2, 3.06, 1.0, 0.22, 1.3, 50.5, -2.24};//new data ddpi result 5
   ...
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7, 0.22, 1.3, 0.8, 3.1};//new data jpsi result 2
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.2 , 0.9 , -2.0 ,1.0, 1300.0, 2.5, 4.36, 3.2, 2.7, 0.22, 1.3, 0.6, 2.0};//new data jpsi result 3
   Double_t para[28] = {4.222, 0.051, 0.184, 4.405, 0.146, 0.309, 2.384, 0.0, 0.0, 0.5, 3.86, 0.31, 0.75 , 4.33 , 0.056 , 2.0 , 1.5, -1.0 ,-2.7, 1515.0, 2.5, 4.36, 3.2, 2.7, 0.22, 1.3, 0.8, -2.0};//new data jpsi result 4
   ...
   gMinuit->mnparm( 26, "gaB_ddpi(4320)"       , para[26], para_step[26], 0.01, 150, ierflg);//
