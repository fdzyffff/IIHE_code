...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   //Double_t para[28] = {4.221 , 0.054, 0.216, 4.398, 0.141, 0.449, 2.274, 0.0, 0.0, 0.459, 3.861, 0.302, 0.547 , 4.325 , 0.07 , 0.073 , 0.254, 0.091, 1.882, 1437.0, 0.471, 3.774, 2.31, 2.001, 0.12, 1.748, 0.8, 3.504};//Default result
   ...
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7,      0.22, 1.3, 0.8, -2.5};//new data jpsi result 2
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.2 , 0.9 , -2.0 ,1.0, 2000.0, 2.5, 4.36, 3.2, 2.7,     0.22, 1.3, 0.8, -2.5};//new data jpsi result 3
   //Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 2.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7,     0.22, 1.3, 0.8, -2.7};//new data jpsi result 4


   //Double_t para[28] = {4.223 , 0.057, 0.5, 4.393, 0.154, 0.6, -2.0, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 0.22, -1.8, 0.8, 3.7};// pi pi hc result 2
   //Double_t para[28] = {4.22 , 0.05, 0.748, 4.406, 0.152, 3.45, 2.29, 0.0, 0.0, 0.324, 3.845, 0.31, 0.54 , 4.32 , 0.09 , 0.09 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7,       3.6, -1.7, 0.8, 3.7};//new data hc result 3
   Double_t para[28] = {4.22 , 0.05, 0.308, 4.406, 0.152, 2.15, 0.24, 0.0, 0.0, 0.324, 3.845, 0.31, 0.54 , 4.32 , 0.09 , 0.09 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7,       1.9, -3.2, 1.2, 1.7};//new data hc result 4
