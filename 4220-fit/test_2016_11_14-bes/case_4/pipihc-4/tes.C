...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.22 , 0.05, 0.308, 4.406, 0.152, 2.15, -0.2, 0.0, 0.0, 0.5, 3.86, 0.36, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 1.7, -3.3, 0.8, 3.7};//new data hc result
