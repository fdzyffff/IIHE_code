...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.057, 0.0, 4.393, 0.154, 0.6, 3.2, 0.0, 0.0, 0.0, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.0, 0.0, 1.86, 1200.0, 0.0, 3.7, 0.0, 1.7, 0, 0, 0, 0};//Default result
   ...
   gMinuit->mnparm( 3, "M(4390)"          , para[3], para_step[3], 4.05, 4.6, ierflg);//4390 in pipihc 
   ...
   gMinuit->mnparm( 10, "M(4008)"         , para[10], para_step[10], 3.6, 4.5, ierflg);
   gMinuit->mnparm( 11, "width(4008)"     , para[11], para_step[11], 0, 0, ierflg);
   gMinuit->mnparm( 12, "gaB(4008)"       , para[12], para_step[12], 0, 50, ierflg);//
