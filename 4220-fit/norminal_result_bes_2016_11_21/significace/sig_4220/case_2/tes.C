...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   gMinuit->mnparm( 0, "M(4220)"          , para[0], para_step[0], 4.2, 4.6, ierflg);//4220
   gMinuit->mnparm( 1, "width(4220)"      , para[1], para_step[1], 0, 1000, ierflg);//4220
   ...
   gMinuit->mnparm( 4, "width(4390)"      , para[4], para_step[4], 0, 1000, ierflg);//4390 in pipihc 
   ...
   gMinuit->mnparm( 11, "width(4008)"     , para[11], para_step[11], 0, 1000, ierflg);
   gMinuit->mnparm( 12, "gaB(4008)"       , para[12], para_step[12], 0, 50, ierflg);//
   gMinuit->mnparm( 13, "M(4320)"         , para[13], para_step[13], 4.2, 4.5, ierflg);//
   gMinuit->mnparm( 14, "width(4320)"     , para[14], para_step[14], 0, 1000, ierflg);//
   gMinuit->mnparm( 15, "gaB(4320)"       , para[15], para_step[15], 0, 50, ierflg);//
   gMinuit->mnparm( 16, "gaB_jpsi(4220)"  , para[16], para_step[16], 0, 1000, ierflg);//
