...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.057, 0.2, 4.393, 0.154, 0.0, 0.0, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 0.0, 2.0, 0.0, 0, 0, 0, 0};//Default result
   ...
   gMinuit->mnparm( 0, "M(4220)"          , para[0], para_step[0], 0, 0, ierflg);//4220
   ...
   gMinuit->mnparm( 13, "M(4320)"         , para[13], para_step[13], 0, 0, ierflg);//
   ...
   gMinuit->mnparm( 19, "CC_ddpi"               , para[19], para_step[19], 1, 3000, ierflg);//constant for PS3 in DDpi
