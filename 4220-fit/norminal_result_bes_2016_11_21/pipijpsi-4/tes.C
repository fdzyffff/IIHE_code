...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.22 , 0.057, 0.4, 4.391, 0.154, 1.2, 3.1, 0.0, 0.0, 3.5, 3.86, 0.35, 0.85 , 4.33 , 0.11 , 2.0 , 1.5, -1.0 ,-2.7, 1326.0, 0.5, 4.0, 2.2, 1.9, 0, 0, 0, 0};//new data jpsi result 4
