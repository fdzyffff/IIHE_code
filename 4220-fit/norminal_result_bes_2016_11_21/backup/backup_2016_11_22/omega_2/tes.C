...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, -0.9, 0.27, 3.83, 0.31, 0.6 , 4.33 , 0.14 , 0.1 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7,0,0,0,0};//new data omega result 2
