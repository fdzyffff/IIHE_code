...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, -10.0, 1.05, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 2.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7,0,0,0,0};//new data jpsi result 4
