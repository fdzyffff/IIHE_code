...
void my_plot_hc(Double_t *par_list)
{
   ...
   legend->AddEntry(gr_hc_data_scan,"Scan ","lp");
...
void my_plot_jpsi(Double_t *par_list)
{
   ...
   legend->AddEntry(gr_jpsi_data_scan,"Scan ","lp");
...
void my_plot_ddpi(Double_t *par_list)
{
   ...
   legend->AddEntry(gr_ddpi_data_scan,"Scan ","lp");
...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.223 , 0.057, 0.401, 4.393, 0.154, 1.6, 3.1, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 1200.0, 0.5, 3.7, 2.0, 1.7, 0, 0, 0, 0};//Default result

   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 7.2, 5.9, -2.2, 2.4, 0, 0, 0, 0};//new data ddpi result 2
   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 2.9, 26.0, -2.2, 4.2, 0, 0, 0, 0};//new data ddpi result 3
   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.067 , 0.26, 0.2, 1.86, 2000.0, 8.4, 35.0, -1.4, 3.94, 0, 0, 0, 0};//new data ddpi result 4



   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 1.3 , 0.3, 0.9, -1.9, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 2
   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 0.2 , 0.9 , -2.0 ,1.0, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 3
   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.5, 3.86, 0.31, 0.55 , 4.33 , 0.056 , 2.0 , 1.1, -0.7 ,-2.5, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data jpsi result 4

   //Double_t para[28] = {4.223 , 0.054, 0.568, 4.383, 0.137, 1.5, 3.7, 0.0, 0.0, 0.27, 3.83, 0.31,, 0.6 , 4.33 , 0.14 , 0.1 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data omega result 2

   //Double_t para[28] = {4.22 , 0.05, 0.26, 4.38, 0.137, 0.83, 2.24, 0.0, 0.0, 0.5, 3.83, 0.31,, 0.6 , 4.33 , 0.14 , 0.1 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7, 0, 0, 0, 0};//new data hc result 2
