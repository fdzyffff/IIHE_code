...
//start minuit
 ...
 // Set starting values and step sizes for parameters
   ...
   Double_t para[28] = {4.22 , 0.05, 0.2, 4.38, 0.137, 0.6, 2.1, -10.0, 1.05, 0.5, 3.83, 0.31, 0.6 , 4.33 , 0.14 , 0.1 , 0.3, -0.2, 2.4, 2000.0, 2.5, 4.36, 3.2, 2.7,0,0,0,0};//new data hc result 2
