...
muon_trig = make_json()
muon_trig.file_name = "Muon/Trigger/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root"
muon_trig.tree_name = "Mu50_PtEtaBins/pt_abseta_ratio"
muon_trig.json_name = "Muon/Trigger/Muon_Trigger_runBCDEF_SF.json"
muon_trig.main()

muon_trig_up = make_json()
muon_trig_up.file_name = "Muon/Trigger/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root"
muon_trig_up.tree_name = "Mu50_PtEtaBins/pt_abseta_ratio"
muon_trig_up.json_name = "Muon/Trigger/sysu_Muon_Trigger_runBCDEF_SF.json"
muon_trig_up.sys_type = "up"
muon_trig_up.extra_err = 0.02
muon_trig_up.main()

muon_trig_down = make_json()
muon_trig_down.file_name = "Muon/Trigger/EfficienciesAndSF_RunBtoF_Nov17Nov2017.root"
muon_trig_down.tree_name = "Mu50_PtEtaBins/pt_abseta_ratio"
muon_trig_down.json_name = "Muon/Trigger/sysd_Muon_Trigger_runBCDEF_SF.json"
muon_trig_down.sys_type = "down"
muon_trig_down.extra_err = 0.02
muon_trig_down.main()

muon_id = make_json()
muon_id.file_name = "Muon/ID/RunBCDEF_SF_ID_syst.root"
muon_id.tree_name = "NUM_HighPtID_DEN_genTracks_pair_newTuneP_probe_pt_abseta"
muon_id.json_name = "Muon/ID/Muon_ID_RunBCDEF_SF_ID.json"
muon_id.main()

muon_id_up = make_json()
muon_id_up.file_name = "Muon/ID/RunBCDEF_SF_ID_syst.root"
muon_id_up.tree_name = "NUM_HighPtID_DEN_genTracks_pair_newTuneP_probe_pt_abseta"
muon_id_up.json_name = "Muon/ID/sysu_Muon_ID_RunBCDEF_SF_ID.json"
muon_id_up.sys_type = "up"
muon_id_up.main()

muon_id_down = make_json()
muon_id_down.file_name = "Muon/ID/RunBCDEF_SF_ID_syst.root"
muon_id_down.tree_name = "NUM_HighPtID_DEN_genTracks_pair_newTuneP_probe_pt_abseta"
muon_id_down.json_name = "Muon/ID/sysd_Muon_ID_RunBCDEF_SF_ID.json"
muon_id_down.sys_type = "down"
muon_id_down.main()

muon_iso = make_json()
muon_iso.file_name = "Muon/Iso/RunBCDEF_SF_ISO_syst.root"
muon_iso.tree_name = "NUM_LooseRelTkIso_DEN_HighPtIDandIPCut_pair_newTuneP_probe_pt_abseta"
muon_iso.json_name = "Muon/Iso/Muon_ISO_RunBCDEF_SF_ISO.json"
muon_iso.main()

muon_iso_up = make_json()
muon_iso_up.file_name = "Muon/Iso/RunBCDEF_SF_ISO_syst.root"
muon_iso_up.tree_name = "NUM_LooseRelTkIso_DEN_HighPtIDandIPCut_pair_newTuneP_probe_pt_abseta"
muon_iso_up.json_name = "Muon/Iso/sysu_Muon_ISO_RunBCDEF_SF_ISO.json"
muon_iso_up.sys_type = "up"
muon_iso_up.main()

muon_iso_down = make_json()
muon_iso_down.file_name = "Muon/Iso/RunBCDEF_SF_ISO_syst.root"
muon_iso_down.tree_name = "NUM_LooseRelTkIso_DEN_HighPtIDandIPCut_pair_newTuneP_probe_pt_abseta"
muon_iso_down.json_name = "Muon/Iso/sysd_Muon_ISO_RunBCDEF_SF_ISO.json"
