...
namespace trigEle33_2018{

  float turnOn_MW(float gsf_Et,float sc_Eta){
    if (0.0<=fabs(sc_Eta) && fabs(sc_Eta)<0.79)
      return turnOnfunction(gsf_Et, 0.9072, 33.79, 0.5449, 0.07102, 34.49, 2.458);
    else if (0.79<=fabs(sc_Eta) && fabs(sc_Eta)<1.1)
      return turnOnfunction(gsf_Et, 0.9017, 33.9, 0.7086, 0.07629, 34.33, 2.679);
    else if (1.1<=fabs(sc_Eta) && fabs(sc_Eta)<1.4442)
      return turnOnfunction(gsf_Et, 0.8823, 34.31, 0.8233, 0.08897, 34.17, 2.707);
    else if (1.566<=fabs(sc_Eta) && fabs(sc_Eta)<1.70)
      return turnOnfunction(gsf_Et, 0.8379, 34.16, 0.8598, 0.1323, 34.5, 2.963);
    else if (1.70<=fabs(sc_Eta) && fabs(sc_Eta)<2.1)
      return turnOnfunction(gsf_Et, 0.8026, 34.31, 0.83, 0.1826, 34.6, 1.968);
    else if (2.1<=fabs(sc_Eta) && fabs(sc_Eta)<2.5)
      return turnOnfunction(gsf_Et, 0.5368, 34.51, 0.9394, 0.4409, 35.32, 1.88);
    else
      return -1.0;
  }
