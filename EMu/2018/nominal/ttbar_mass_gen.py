...
parser.add_option("-i","--root_file",dest="root_file",default="",type="str")
...
def fill_hist(input_file, output_file, weight_factor):
	global reskim_dic
...
make_hist()
fill_hist(options.i, options.o, options.w)
