...
////////////////////////////////////////////
   ...
   Int_t trig_Mu24_fire ;
   Int_t trig_TkMu24_fire ;
   ...
   Int_t trig_DouEle33MW_fire;

   Int_t Muon50_trig_fire;
   Int_t OldMu100_trig_fire;
   Int_t TkMu100_trig_fire;
   Int_t Photon175_trig_fire;
   Int_t Ele115_trig_fire;

   vector<float> *trig_dou33_eta;
   vector<float> *trig_dou33_phi;
   vector<float> *trig_dou33Et_eta;
   vector<float> *trig_dou33Et_phi;
   vector<float> *trig_dou33HE_eta;
   vector<float> *trig_dou33HE_phi;
   ...
   vector<float> *trig_dou33_L1s_eta;
   vector<float> *trig_dou33_L1s_phi;
   vector<float> *trig_dou33_L1s_et;
   vector<float> *trig_dou33_EGL1_eta;
   vector<float> *trig_dou33_EGL1_phi;
   vector<float> *trig_dou33_EGL1_et;

   vector<float> *trig_dou33MW_eta;
   vector<float> *trig_dou33MW_phi;
   vector<float> *trig_dou33MWEt_eta;
   vector<float> *trig_dou33MWEt_phi;
   vector<float> *trig_dou33MWHE_eta;
   vector<float> *trig_dou33MWHE_phi;
   vector<float> *trig_dou33MWEt_unseeded_eta;
   vector<float> *trig_dou33MWEt_unseeded_phi;
   vector<float> *trig_dou33MW_unseeded_eta;
   vector<float> *trig_dou33MW_unseeded_phi;
   vector<float> *trig_dou33MW_L1s_eta;
   vector<float> *trig_dou33MW_L1s_phi;
   vector<float> *trig_dou33MW_L1s_et;
   vector<float> *trig_dou33MW_EGL1_eta;
   vector<float> *trig_dou33MW_EGL1_phi;
   vector<float> *trig_dou33MW_EGL1_et;
...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   TBranch *b_trig_Mu24_fire ;
   TBranch *b_trig_TkMu24_fire ;
   ...
   TBranch *b_trig_DouEle33MW_fire;

   TBranch *b_Muon50_trig_fire;
   TBranch *b_OldMu100_trig_fire;
   TBranch *b_TkMu100_trig_fire;
   TBranch *b_Photon175_trig_fire;
   TBranch *b_Ele115_trig_fire;

   TBranch *b_trig_dou33_eta;
   TBranch *b_trig_dou33_phi;
   TBranch *b_trig_dou33Et_eta;
   TBranch *b_trig_dou33Et_phi;
   TBranch *b_trig_dou33HE_eta;
   TBranch *b_trig_dou33HE_phi;
   TBranch *b_trig_dou33Et_unseeded_eta;
   TBranch *b_trig_dou33Et_unseeded_phi;
   TBranch *b_trig_dou33_unseeded_eta;
   TBranch *b_trig_dou33_unseeded_phi;
   TBranch *b_trig_dou33_L1s_eta;
   TBranch *b_trig_dou33_L1s_phi;
   TBranch *b_trig_dou33_L1s_et;
   TBranch *b_trig_dou33_EGL1_eta;
   TBranch *b_trig_dou33_EGL1_phi;
   TBranch *b_trig_dou33_EGL1_et;

   TBranch *b_trig_dou33MW_eta;
   TBranch *b_trig_dou33MW_phi;
   TBranch *b_trig_dou33MWEt_eta;
   TBranch *b_trig_dou33MWEt_phi;
   TBranch *b_trig_dou33MWHE_eta;
   TBranch *b_trig_dou33MWHE_phi;
   TBranch *b_trig_dou33MWEt_unseeded_eta;
   TBranch *b_trig_dou33MWEt_unseeded_phi;
   TBranch *b_trig_dou33MW_unseeded_eta;
   TBranch *b_trig_dou33MW_unseeded_phi;
   TBranch *b_trig_dou33MW_L1s_eta;
   TBranch *b_trig_dou33MW_L1s_phi;
   TBranch *b_trig_dou33MW_L1s_et;
   TBranch *b_trig_dou33MW_EGL1_eta;
   TBranch *b_trig_dou33MW_EGL1_phi;
   TBranch *b_trig_dou33MW_EGL1_et;
   ...
   reskim(TTree *tree=0, bool isData_in=false, bool isDY_in=false, bool isTTbar_in=false, bool isWW_in=false, string mc_str_in = "", TString sys_str_in = "norminal", UInt_t No_print_in = 0, int triggerVersion_in = 0, UInt_t runNo1_in=0, UInt_t runNo2_in=999999);
   virtual ~reskim();
...
#ifdef reskim_cxx
reskim::reskim(TTree *tree, bool isData_in, bool isDY_in, bool isTTbar_in, bool isWW_in, string mc_str_in, TString sys_str_in, UInt_t No_print_in, int triggerVersion_in, UInt_t runNo1_in, UInt_t runNo2_in)
{
...
void reskim::Init(TTree *tree)
{
   ...
   ev_prefiringweight = 1.0;
   ev_prefiringweightup = 1.0;
   ev_prefiringweightdown = 1.0;
   mc_index = 0;
   mc_pdgId = 0;
   mc_charge = 0;
   mc_status = 0;
   ...
   trig_DouEle33MW_fire =0;

   Muon50_trig_fire =0;
   OldMu100_trig_fire =0;
   TkMu100_trig_fire =0;
   Photon175_trig_fire =0;
   Ele115_trig_fire =0;
   ...
   trig_dou33HE_eta = 0;
   trig_dou33HE_phi = 0;
   trig_dou33Et_unseeded_eta = 0;
   trig_dou33Et_unseeded_phi = 0;
   trig_dou33_unseeded_eta = 0;
   trig_dou33_unseeded_phi = 0;
   trig_dou33_L1s_eta = 0;
   trig_dou33_L1s_phi = 0;
   trig_dou33_L1s_et = 0;
   trig_dou33_EGL1_eta = 0;
   trig_dou33_EGL1_phi = 0;
   trig_dou33_EGL1_et = 0;

   trig_dou33MW_eta = 0;
   trig_dou33MW_phi = 0;
   trig_dou33MWEt_eta = 0;
   trig_dou33MWEt_phi = 0;
   trig_dou33MWHE_eta = 0;
   trig_dou33MWHE_phi = 0;
   trig_dou33MWEt_unseeded_eta = 0;
   trig_dou33MWEt_unseeded_phi = 0;
   trig_dou33MW_unseeded_eta = 0;
   trig_dou33MW_unseeded_phi = 0;
   trig_dou33MW_L1s_eta = 0;
   trig_dou33MW_L1s_phi = 0;
   trig_dou33MW_L1s_et = 0;
   trig_dou33MW_EGL1_eta = 0;
   trig_dou33MW_EGL1_phi = 0;
   trig_dou33MW_EGL1_et = 0;
...
//   fChain->SetBranchAddress("gsf_VIDTight", &gsf_VIDTight, &b_gsf_VIDTight);
   fChain->SetBranchAddress("gsf_VID_heepElectronID_HEEPV70",  &gsf_isHeepV7,  &b_gsf_isHeepV7);
   ...
   fChain->SetBranchAddress("gsf_heepTrkPtIso", &gsf_dr03TkSumPt, &b_gsf_dr03TkSumPt);
   ...
   fChain->SetBranchAddress("gsf_ecalEnergyPostCorr", &gsf_ecalEnergy, &b_gsf_ecalEnergy);
...
//for muon:
   ...
   fChain->SetBranchAddress("mu_ibt_charge", &mu_ibt_charge, &b_mu_ibt_p);
   ...
   {
     if(strstr(tmp_array->At(i)->GetName(),"trig_Flag_duplicateMuons_accept"))
     {
        cout<<"branch : trig_Flag_duplicateMuons_accept included"<<endl;
     ...
     if(strstr(tmp_array->At(i)->GetName(),"trig_Flag_badMuons_accept"))
     {  
        cout<<"branch : trig_Flag_badMuons_accept included"<<endl;
        fChain->SetBranchAddress("trig_Flag_badMuons_accept", &trig_Flag_badMuons_accept, &b_trig_Flag_badMuons_accept);
     }
     if(strstr(tmp_array->At(i)->GetName(),"trig_Flag_noBadMuons_accept"))
     {  
        cout<<"branch : trig_Flag_noBadMuons_accept included"<<endl;
...
//   set trigger for eff study
   //set DoubleEle33 trigger
   i = 0;
//   for(i = 0; i<tmp_array->GetEntries(); i++)
//   { 
//      //old trigger
//      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_accept"))
//      {
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_accept"          , &trig_DouEle33_fire, &b_trig_DouEle33_fire) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEle33CaloIdLGsfTrkIdVLDPhiFilter_eta", &trig_dou33_eta, &b_trig_dou33_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEle33CaloIdLGsfTrkIdVLDPhiFilter_phi", &trig_dou33_phi, &b_trig_dou33_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEG33EtFilter_eta", &trig_dou33Et_eta, &b_trig_dou33Et_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEG33EtFilter_phi", &trig_dou33Et_phi, &b_trig_dou33Et_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEG33HEFilter_eta", &trig_dou33HE_eta, &b_trig_dou33HE_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEG33HEFilter_phi", &trig_dou33HE_phi, &b_trig_dou33HE_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltDiEG33EtUnseededFilter_eta", &trig_dou33Et_unseeded_eta, &b_trig_dou33Et_unseeded_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltDiEG33EtUnseededFilter_phi", &trig_dou33Et_unseeded_phi, &b_trig_dou33Et_unseeded_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltDiEle33CaloIdLGsfTrkIdVLDPhiUnseededFilter_eta", &trig_dou33_unseeded_eta, &b_trig_dou33_unseeded_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltDiEle33CaloIdLGsfTrkIdVLDPhiUnseededFilter_phi", &trig_dou33_unseeded_phi, &b_trig_dou33_unseeded_phi) ;
//      }
//      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau"))
//      {   
//         cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau included"<<endl;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau_eta", &trig_dou33_L1s_eta, &b_trig_dou33_L1s_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau_phi", &trig_dou33_L1s_phi, &b_trig_dou33_L1s_phi) ;
//         //fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau_et", &trig_dou33_L1s_et, &b_trig_dou33_L1s_et) ;
//      }
//      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter"))
//      {   
//         cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter included"<<endl;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_eta", &trig_dou33_EGL1_eta, &b_trig_dou33_EGL1_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_phi", &trig_dou33_EGL1_phi, &b_trig_dou33_EGL1_phi) ;
//         //fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_et", &trig_dou33_EGL1_et, &b_trig_dou33_EGL1_et) ;
//      }
      //MW trigger 
//      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_MW_accept"))
//      {
//         cout<<"Trigger : HLT_DoubleEle33_CaloIdL_MW included"<<endl;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_accept"                     , &trig_DouEle33MW_fire, &b_trig_DouEle33MW_fire) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEle33CaloIdLMWPMS2Filter_eta", &trig_dou33MW_eta, &b_trig_dou33MW_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEle33CaloIdLMWPMS2Filter_phi", &trig_dou33MW_phi, &b_trig_dou33MW_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33EtFilter_eta", &trig_dou33MWEt_eta, &b_trig_dou33MWEt_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33EtFilter_phi", &trig_dou33MWEt_phi, &b_trig_dou33MWEt_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33HEFilter_eta", &trig_dou33MWHE_eta, &b_trig_dou33MWHE_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33HEFilter_phi", &trig_dou33MWHE_phi, &b_trig_dou33MWHE_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEG33EtUnseededFilter_eta", &trig_dou33MWEt_unseeded_eta, &b_trig_dou33MWEt_unseeded_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEG33EtUnseededFilter_phi", &trig_dou33MWEt_unseeded_phi, &b_trig_dou33MWEt_unseeded_phi) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEle33CaloIdLMWPMS2UnseededFilter_eta", &trig_dou33MW_unseeded_eta, &b_trig_dou33MW_unseeded_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEle33CaloIdLMWPMS2UnseededFilter_phi", &trig_dou33MW_unseeded_phi, &b_trig_dou33MW_unseeded_phi) ;
//      } 
//      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_MW_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau"))
//      {   
//         cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_MW_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau included"<<endl;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau_eta", &trig_dou33MW_L1s_eta, &b_trig_dou33MW_L1s_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau_phi", &trig_dou33MW_L1s_phi, &b_trig_dou33MW_L1s_phi) ;
//         //fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltL1sSingleAndDoubleEGNonIsoOrWithEG26WithJetAndTau_et", &trig_dou33MW_L1s_et, &b_trig_dou33MW_L1s_et) ;
//      }
//      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter"))
//      {   
//         cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter included"<<endl;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_eta", &trig_dou33MW_EGL1_eta, &b_trig_dou33MW_EGL1_eta) ;
//         fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_phi", &trig_dou33MW_EGL1_phi, &b_trig_dou33MW_EGL1_phi) ;
//         //fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_et", &trig_dou33MW_EGL1_et, &b_trig_dou33MW_EGL1_et) ;
//      }
//   }
   //set Muon and Photon trigger
   fChain->SetBranchAddress("trig_HLT_Mu50_accept", &Muon50_trig_fire, &b_Muon50_trig_fire) ;
   fChain->SetBranchAddress("trig_HLT_OldMu100_accept", &OldMu100_trig_fire, &b_OldMu100_trig_fire) ;

   fChain->SetBranchAddress("trig_HLT_Photon175_accept", &Photon175_trig_fire, &b_Photon175_trig_fire) ;

   fChain->SetBranchAddress("trig_HLT_Ele115_CaloIdVT_GsfTrkIdT_accept", &Ele115_trig_fire, &b_Ele115_trig_fire) ;

   for(i = 0; i<tmp_array->GetEntries(); i++)
   {
      //cout<< tmp_array->At(i)->GetName()<<endl;
      if(strstr(tmp_array->At(i)->GetName(),"HLT_TkMu100"))
      {
         cout<<"branch : HLT_TkMu100 included"<<endl;
         fChain->SetBranchAddress("trig_HLT_TkMu100_accept", &TkMu100_trig_fire, &b_TkMu100_trig_fire) ;
         break;
      }
   }
   ...
   fChain->SetBranchAddress("trig_HLT_Ele25_eta2p1_WPTight_Gsf_accept"                   , &trig_Ele25_fire         , &b_trig_Ele25_fire        ) ;
   fChain->SetBranchAddress("trig_HLT_IsoMu24_accept"    , &trig_Mu24_fire, &b_trig_Mu24_fire) ;
   fChain->SetBranchAddress("trig_HLT_IsoTkMu24_accept"    , &trig_TkMu24_fire, &b_trig_TkMu24_fire) ;

   i = 0;
   for(i = 0; i<tmp_array->GetEntries(); i++)
   { 
     if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_MW_accept"))
     {
     ...
     if (triggerVersion == 0 || (!isData))
     {
         ...
         else if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept"))
         {
         ...
         if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_accept"))
         {
            fChain->SetBranchAddress("trig_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_accept"             , &trig_Mu17_TkMu8_fire,  &b_trig_Mu17_TkMu8_fire) ;
         } 
         if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_accept"))
         {
            fChain->SetBranchAddress("trig_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_accept"               , &trig_Mu17_Mu8_fire  ,  &b_trig_Mu17_Mu8_fire  ) ;
         } 
     }
     else if (triggerVersion == 1)
     {
        if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept"))
        {  
           cout<<"use dz trigger: trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept"<<endl;
        ...
        if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept"))
        {
           fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept", &trig_Mu23_Ele12_fire,  &b_trig_Mu23_Ele12_fire) ;
        } 
        if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_accept"))
        {
           fChain->SetBranchAddress("trig_HLT_Mu17_TrkIsoVVL_TkMu8_TrkIsoVVL_DZ_accept"             , &trig_Mu17_TkMu8_fire,  &b_trig_Mu17_TkMu8_fire) ;
        } 
        if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_Mu17_TrkIsoVVL_Mu8_TrkIsoVVL_DZ_accept"))
        {
