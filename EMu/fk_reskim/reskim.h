...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   reskim(TTree *tree=0, bool isData_in=false, bool isDY_in=false, bool isTTbar_in=false, bool isWW_in=false, UInt_t No_print_in = 0, int triggerVersion_in = 0, UInt_t runNo1_in=0, UInt_t runNo2_in=999999);
   virtual ~reskim();
...
#ifdef reskim_cxx
reskim::reskim(TTree *tree, bool isData_in, bool isDY_in, bool isTTbar_in, bool isWW_in, UInt_t No_print_in, int triggerVersion_in, UInt_t runNo1_in, UInt_t runNo2_in)
{
