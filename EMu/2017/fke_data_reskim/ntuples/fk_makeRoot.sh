...
hadd -f output/fke_DYToLL_all.root	 		batchmc/fke_2017_MC*_DYToLL_*_nor_*.root
hadd -f output/fke_ttbar2l2u_all.root			batchmc/fke_2017_MC*_ttbar2l2u_*_nor_*.root
hadd -f output/fke_ST.root 				batchmc/fke_2017_MC*_ST_*_nor_*.root
hadd -f output/fke_WW.root 				batchmc/fke_2017_MC*_WW_*_nor_*.root
hadd -f output/fke_WZ.root				batchmc/fke_2017_MC*_WZ_*_nor_*.root
hadd -f output/fke_ZZ.root 				batchmc/fke_2017_MC*_ZZ_*_nor_*.root
