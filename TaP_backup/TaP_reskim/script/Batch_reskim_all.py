...
#"../Data/rB_1" :[[True,False,False],[51,0]],
#"../Data/rB_2" :[[True,False,False],[51,0]],
#"../Data/rC_1" :[[True,False,False],[51,0]],
#"../Data/rC_2" :[[True,False,False],[51,0]],
#"../Data/rC_3" :[[True,False,False],[51,0]],
"../Data/rD_1" :[[True,False,False],[51,0]],
#"../Data/rE_1" :[[True,False,False],[51,0]],
"../Data/rF_1" :[[True,False,False],[51,0]],
}
reskim_dic={
}
...
def make_sub(label,n_file_per_job):
    ...
    for reskim in reskim_dic:
        ...
        triggerVersion_33 = reskim_dic[reskim][2][0]
        n_job = 0
        sub_n_total_job = 0
        n_start = True
        job_text = ""
        ...
        for root_file in reskim_dic[reskim][1]:
            ...
            if (not isCheck) or (not output_name in reskim_dic[reskim][3]):
                job_text+=("python reskim_all.py -r %s -o %s --isData %s -t %s\n"%(root_file, output_name, isData, triggerVersion_33))
                n_job+=1
            i+=1
...
make_sub("2017_SingleElectron",50)
