...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Long_t          ev_event;
   Long_t          ev_run;
   Long_t          ev_luminosityBlock;
   Long_t          ev_time;
   Long_t          ev_time_unixTime;
   Long_t          ev_time_microsecondOffset;
...
////////////////////////////////////////////
   ...
   vector<float> *trig_ele35_eta_v1 ;
   vector<float> *trig_ele35_phi_v1 ;
   vector<float> *trig_ele35_eta_v2 ;
   vector<float> *trig_ele35_phi_v2 ;
...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   TBranch *b_trig_ele35_eta_v1  ;
   TBranch *b_trig_ele35_phi_v1  ;
   TBranch *b_trig_ele35_eta_v2  ;
   TBranch *b_trig_ele35_phi_v2  ;
...
//
   ...
   if(true==isData){
     ...
     //fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_hltEle27erWPTightGsfTrackIsoFilter_eta", &trig_ele35_eta_v1, &b_trig_ele35_eta_v1) ;
     //fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_hltEle27erWPTightGsfTrackIsoFilter_phi", &trig_ele35_phi_v1, &b_trig_ele35_phi_v1) ;

     fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_accept", &trig_fire_v1, &b_trig_fire_v1) ;
     fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfTrackIsoFilter_eta", &trig_ele35_eta_v1, &b_trig_ele35_eta_v1) ;
     fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_hltEle35noerWPTightGsfTrackIsoFilter_phi", &trig_ele35_phi_v1, &b_trig_ele35_phi_v1) ;
     ...
     {       
       ...
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEle33CaloIdLMWPMS2Filter_eta", &trig_dou33_eta, &b_trig_dou33_eta) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEle33CaloIdLMWPMS2Filter_phi", &trig_dou33_phi, &b_trig_dou33_phi) ;
