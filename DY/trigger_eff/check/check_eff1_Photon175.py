...
update = False
update = True
label ='eff_DoubleEle33_SingleMuon_Photon175_matchedMethod.png'
label2=label[:-4]
title='HLT Photon175 effciency'
...
#        if n_processed > 800000:break
        ...
        pass_flag = getattr(event,'Photon175_trig_fire')
...
gr.GetXaxis().SetRangeUser(150,1050 )

gr.GetYaxis().SetRangeUser(0.95,1.05 )
