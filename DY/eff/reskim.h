...
////////////////////////////////////////////
   ...
   Int_t trig_fire_v1 ;
   Int_t trig_fire_v2 ;
   Int_t Ele33_trig_fire ;
   vector<float> *trig_dou33_eta ;
   vector<float> *trig_dou33_phi ;
   vector<float> *trig_dou33L1_eta ;
   vector<float> *trig_dou33L1_et ;
   vector<float> *trig_dou33L1_phi ;
...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   TBranch *b_Ele33_trig_fire ;
   TBranch *b_trig_fire_v2 ;
   TBranch *b_trig_dou33_eta  ;
   TBranch *b_trig_dou33_phi  ;
   TBranch *b_trig_dou33L1_eta  ;
   TBranch *b_trig_dou33L1_et  ;
   TBranch *b_trig_dou33L1_phi  ;
   ...
   TBranch *b_trig_ele27_eta_v1  ;
   TBranch *b_trig_ele27_phi_v1  ;
   TBranch *b_trig_ele27_eta_v2  ;
   TBranch *b_trig_ele27_phi_v2  ;
   ...
   bool isWJets ;
   int triggerVersion ;
   int triggerVersion_DoubleE33 ;

   float goldenLumi ;
   float silverLumi ;
   float combinedLumi ;

   reskim(TTree *tree=0, bool isData_in=false, bool isZToTT_in=false, bool isWJets_in=false, int triggerVersion_DoubleE33_in=0, int triggerVersion_in=0);
   virtual ~reskim();
...
#ifdef reskim_cxx
reskim::reskim(TTree *tree, bool isData_in, bool isZToTT_in, bool isWJets_in, int triggerVersion_DoubleE33_in,  int triggerVersion_in) :
fChain(0),
goldenLumi(2260.0), 
silverLumi(370.0), 
combinedLumi(2630.0)
...
// used to generate this class and read the Tree.
   ...
   triggerVersion_DoubleE33 = triggerVersion_DoubleE33_in ;
   Init(tree);
}
...
//for muon:
   ...
   fChain->SetBranchAddress("mu_it_charge", &mu_it_charge, &b_mu_it_p);
...
//
   ...
   if(true==isData){
     fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_accept", &trig_fire_v1, &b_trig_fire_v1) ;
     fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_hltEle27erWPTightGsfTrackIsoFilter_eta", &trig_ele27_eta_v1, &b_trig_ele27_eta_v1) ;
     fChain->SetBranchAddress("trig_HLT_Ele27_eta2p1_WPTight_Gsf_hltEle27erWPTightGsfTrackIsoFilter_phi", &trig_ele27_phi_v1, &b_trig_ele27_phi_v1) ;



     if(triggerVersion_DoubleE33==1)
     {
       ...
       for(i = 0; i<tmp_array->GetEntries(); i++)
       {
         ...
         if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter"))
         {
             cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter included"<<endl;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter_eta", &trig_dou33L1_eta, &b_trig_dou33L1_eta) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter_phi", &trig_dou33L1_phi, &b_trig_dou33L1_phi) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter_et", &trig_dou33L1_et, &b_trig_dou33L1_et) ;
             break;
         }
         ...
         {   
             ...
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_eta", &trig_dou33L1_eta, &b_trig_dou33L1_eta) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_phi", &trig_dou33L1_phi, &b_trig_dou33L1_phi) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_et", &trig_dou33L1_et, &b_trig_dou33L1_et) ;
             break;
         }
         if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter"))                {
             cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter included"<<endl;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter_eta", &trig_dou33L1_eta, &b_trig_dou33L1_eta) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter_phi", &trig_dou33L1_phi, &b_trig_dou33L1_phi) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter_et", &trig_dou33L1_et, &b_trig_dou33L1_et) ;
             break;
         }
       }
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_accept", &Ele33_trig_fire, &b_Ele33_trig_fire) ;
     ...
     else if(triggerVersion_DoubleE33==51)
     {       
       TObjArray *tmp_array = fChain->GetListOfBranches();
       int i = 0;
       for(i = 0; i<tmp_array->GetEntries(); i++)
       {
         if(strstr(tmp_array->At(i)->GetName(),"g_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter"))
         {   
             cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter included"<<endl;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter_eta", &trig_dou33L1_eta, &b_trig_dou33L1_eta) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter_phi", &trig_dou33L1_phi, &b_trig_dou33L1_phi) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORSingleJet200Filter_et", &trig_dou33L1_et, &b_trig_dou33L1_et) ;
             break;
         }
         if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter"))
         {
             cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter included"<<endl;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter_eta", &trig_dou33L1_eta, &b_trig_dou33L1_eta) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter_phi", &trig_dou33L1_phi, &b_trig_dou33L1_phi) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleEG40OR30OR26ORDoubleEG2210OR2417ORL1EGHighPtSeedsFilter_et", &trig_dou33L1_et, &b_trig_dou33L1_et) ;
             break;
         }
         if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter"))               
         {
             ...
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_eta", &trig_dou33L1_eta, &b_trig_dou33L1_eta) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_phi", &trig_dou33L1_phi, &b_trig_dou33L1_phi) ;
             fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_et", &trig_dou33L1_et, &b_trig_dou33L1_et) ;
             break;
         }
       }
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_accept", &Ele33_trig_fire, &b_Ele33_trig_fire) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33CaloIdLMWPMS2Filter_eta", &trig_dou33_eta, &b_trig_dou33_eta) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33CaloIdLMWPMS2Filter_phi", &trig_dou33_phi, &b_trig_dou33_phi) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33EtFilter_eta", &trig_dou33Et_eta, &b_trig_dou33Et_eta) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltEG33EtFilter_phi", &trig_dou33Et_phi, &b_trig_dou33Et_phi) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEG33EtUnseededFilter_eta", &trig_dou33Et_unseeded_eta, &b_trig_dou33Et_unseeded_eta) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEG33EtUnseededFilter_phi", &trig_dou33Et_unseeded_phi, &b_trig_dou33Et_unseeded_phi) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEle33CaloIdLMWPMS2UnseededFilter_eta", &trig_dou33_unseeded_eta, &b_trig_dou33_unseeded_eta) ;
       fChain->SetBranchAddress("trig_HLT_DoubleEle33_CaloIdL_MW_hltDiEle33CaloIdLMWPMS2UnseededFilter_phi", &trig_dou33_unseeded_phi, &b_trig_dou33_unseeded_phi) ;
     }
   }
