...
update = False
update = True
label='eff2_DoubleEle33_SingleElectron_Et_matchedMethod.png'
label2='eff2_DoubleEle33_SingleElectron_Et_matchedMethod'
title='HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_v Et cut effciency (2016 B-H)'
my_eta_start_No = 3#etaList = [[0.0,0.79],[0.79,1.1],[1.1,1.4442],[1.556,1.7],[1.7,2.1],[2.1,2.5]]
def my_sum(tmp_dic):
    n=0
    for l in tmp_dic:
        n+=tmp_dic[l]
...
#            print pass_dic
        ...
        pass_Et = getattr(event,'probe_Et_fired')
