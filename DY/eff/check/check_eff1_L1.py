...
update = False
update = True
label ='eff1_DoubleEle33_L1_SingleElectron_matchedMethod.png'
label2='eff1_DoubleEle33_L1_SingleElectron_matchedMethod'
...
my_func_2 = ROOT.TF1('eff_func_2','0.5*[0]*(1+erf((x-[1])/(1.414*[2])))+0.5*[3]*(1+erf((x-[4])/(1.414*[5])))',20,80)
my_func_2.SetParameters(0.9,-8,17,0.07,41,3.0)
