...
root_dir_dic ={
'rA_1'	:['/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_v2/EGamma/crab_EGamma_A/',[]],
'rB_1'	:['/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_v2/EGamma/crab_EGamma_B/',[]],
'rC_1'	:['/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_v2/EGamma/crab_EGamma_C/',[]],
'rD_2'	:['/pnfs/iihe/cms/store/user/amkalsi/2018_ReReco_v2/EGamma/crab_EGamma_D/',[]],
}
rootfile_list = []
...
def scanFile():
    ...
    for rootfile_dir in root_dir_dic:
        tmp_dir_str = root_dir_dic[rootfile_dir][0]
        if "/" != root_dir_dic[rootfile_dir][0][-1]:
