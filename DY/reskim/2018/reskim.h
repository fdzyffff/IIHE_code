...
////////////////////////////////////////////
   ...
   Int_t trig_DouEle25_fire;
   Int_t trig_DouEle25MW_fire;

   Int_t Muon50_trig_fire;
   Int_t TkMu50_trig_fire;
   ...
   vector<float> *trig_dou25MW_eta;
   vector<float> *trig_dou25MW_phi;
   vector<float> *trig_dou25MWEt_eta;
   vector<float> *trig_dou25MWEt_phi;
   vector<float> *trig_dou25MWHE_eta;
   vector<float> *trig_dou25MWHE_phi;
   vector<float> *trig_dou25MWEt_unseeded_eta;
   vector<float> *trig_dou25MWEt_unseeded_phi;
   vector<float> *trig_dou25MW_unseeded_eta;
   vector<float> *trig_dou25MW_unseeded_phi;
   vector<float> *trig_dou25MW_L1s_eta;
   vector<float> *trig_dou25MW_L1s_phi;
   vector<float> *trig_dou25MW_L1s_et;
   vector<float> *trig_dou25MW_EGL1_eta;
   vector<float> *trig_dou25MW_EGL1_phi;
   vector<float> *trig_dou25MW_EGL1_et;
...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   TBranch *b_trig_DouEle25MW_fire;

   TBranch *b_Muon50_trig_fire;
   TBranch *b_TkMu50_trig_fire;
   ...
   TBranch *b_trig_dou25MW_eta;
   TBranch *b_trig_dou25MW_phi;
   TBranch *b_trig_dou25MWEt_eta;
   TBranch *b_trig_dou25MWEt_phi;
   TBranch *b_trig_dou25MWHE_eta;
   TBranch *b_trig_dou25MWHE_phi;
   TBranch *b_trig_dou25MWEt_unseeded_eta;
   TBranch *b_trig_dou25MWEt_unseeded_phi;
   TBranch *b_trig_dou25MW_unseeded_eta;
   TBranch *b_trig_dou25MW_unseeded_phi;
   TBranch *b_trig_dou25MW_L1s_eta;
   TBranch *b_trig_dou25MW_L1s_phi;
   TBranch *b_trig_dou25MW_L1s_et;
   TBranch *b_trig_dou25MW_EGL1_eta;
   TBranch *b_trig_dou25MW_EGL1_phi;
   TBranch *b_trig_dou25MW_EGL1_et;
   ...
   reskim(TTree *tree=0, bool isData_in=false, bool isDYToTT_in=false, bool isDYToEE_in=false, bool isWW_in=false, string mc_str_in = "", UInt_t No_print_in = 0, int triggerVersion_in = 0, UInt_t runNo1_in=0, UInt_t runNo2_in=999999);
   virtual ~reskim();
...
#ifdef reskim_cxx
reskim::reskim(TTree *tree, bool isData_in, bool isDYToTT_in, bool isDYToEE_in, bool isWW_in, string mc_str_in, UInt_t No_print_in, int triggerVersion_in, UInt_t runNo1_in, UInt_t runNo2_in)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.

   isData  = isData_in  ;
   isDYToTT = isDYToTT_in ;
   isDYToEE = isDYToEE_in ;
   isWW = isWW_in ;
   runNo1 = runNo1_in ;
   runNo2 = runNo2_in ;
...
void reskim::Init(TTree *tree)
{
   ...
   trig_dou25MW_eta = 0;
   trig_dou25MW_phi = 0;
   trig_dou25MWEt_eta = 0;
   trig_dou25MWEt_phi = 0;
   trig_dou25MWHE_eta = 0;
   trig_dou25MWHE_phi = 0;
   trig_dou25MWEt_unseeded_eta = 0;
   trig_dou25MWEt_unseeded_phi = 0;
   trig_dou25MW_unseeded_eta = 0;
   trig_dou25MW_unseeded_phi = 0;
   trig_dou25MW_L1s_eta = 0;
   trig_dou25MW_L1s_phi = 0;
   trig_dou25MW_L1s_et = 0;
   trig_dou25MW_EGL1_eta = 0;
   trig_dou25MW_EGL1_phi = 0;
   trig_dou25MW_EGL1_et = 0;
...
//   fChain->SetBranchAddress("ev_rho_kt6PFJetsForIsolation", &ev_rho_kt6PFJetsForIsolation, &b_ev_rho_kt6PFJetsForIsolation);
   if(isData==false){
      ...
      {
         if(strstr(tmp_array->At(i)->GetName(),"mc_pdgId"))
         {
            cout<<"branch : mc_* included"<<endl;
         ...
         if(strstr(tmp_array->At(i)->GetName(),"LHE_Pt"))
         {
...
//   fChain->SetBranchAddress("gsf80_caloEnergyPostCorr",  &gsf80_caloEnergy,  &b_gsf80_caloEnergy);
...
//   set trigger for eff study
   ...
   { 
      ...
      {
         cout<<"HLT_DoubleEle33_CaloIdL_MW found, but not used"<<endl;
   ...
   for(i = 0; i<tmp_array->GetEntries(); i++)
   { 
      if(strstr(tmp_array->At(i)->GetName(),"trig_HLT_DoubleEle25_CaloIdL_MW_accept"))
      {
         cout<<"HLT_DoubleEle25_CaloIdL_MW found, but not used"<<endl;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_accept"                     , &trig_DouEle25MW_fire, &b_trig_DouEle25MW_fire) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_eta", &trig_dou25MW_EGL1_eta, &b_trig_dou25MW_EGL1_eta) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_phi", &trig_dou25MW_EGL1_phi, &b_trig_dou25MW_EGL1_phi) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEGL1SingleAndDoubleEGNonIsoOrWithEG26WithJetAndTauFilter_et", &trig_dou25MW_EGL1_et, &b_trig_dou25MW_EGL1_et) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEle25CaloIdLMWPMS2Filter_eta", &trig_dou25MW_eta, &b_trig_dou25MW_eta) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEle25CaloIdLMWPMS2Filter_phi", &trig_dou25MW_phi, &b_trig_dou25MW_phi) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEG25EtFilter_eta", &trig_dou25MWEt_eta, &b_trig_dou25MWEt_eta) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEG25EtFilter_phi", &trig_dou25MWEt_phi, &b_trig_dou25MWEt_phi) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEG25HEFilter_eta", &trig_dou25MWHE_eta, &b_trig_dou25MWHE_eta) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltEG25HEFilter_phi", &trig_dou25MWHE_phi, &b_trig_dou25MWHE_phi) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltDiEG25EtUnseededFilter_eta", &trig_dou25MWEt_unseeded_eta, &b_trig_dou25MWEt_unseeded_eta) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltDiEG25EtUnseededFilter_phi", &trig_dou25MWEt_unseeded_phi, &b_trig_dou25MWEt_unseeded_phi) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltDiEle25CaloIdLMWPMS2UnseededFilter_eta", &trig_dou25MW_unseeded_eta, &b_trig_dou25MW_unseeded_eta) ;
         fChain->SetBranchAddress("trig_HLT_DoubleEle25_CaloIdL_MW_hltDiEle25CaloIdLMWPMS2UnseededFilter_phi", &trig_dou25MW_unseeded_phi, &b_trig_dou25MW_unseeded_phi) ;
         break;
      } 
   }
   ...
   for(i = 0; i<tmp_array->GetEntries(); i++)
   {
      ...
      if(strstr(tmp_array->At(i)->GetName(),"HLT_TkMu50"))
      {
         cout<<"branch : HLT_TkMu50 included"<<endl;
         fChain->SetBranchAddress("trig_HLT_TkMu50_accept", &TkMu50_trig_fire, &b_TkMu50_trig_fire) ;
         break;
      }
   }
