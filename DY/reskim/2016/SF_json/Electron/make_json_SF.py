...
#main()
#write_json(get_2D_json("reco/egammaEffi.txt_EGM2D_updatedAll.root","EGamma_SF2D",True),"reco/Electron_reco_run2018_json.txt")
#print "*"*50
write_json(get_2D_json("reco/EGM2D_BtoH_GT20GeV_RecoSF_Legacy2016.root","EGamma_SF2D",True),"reco/Electron_reco_run2016_json.txt")
