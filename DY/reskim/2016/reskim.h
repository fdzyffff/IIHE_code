...
//   fChain->SetBranchAddress("ev_rho_kt6PFJetsForIsolation", &ev_rho_kt6PFJetsForIsolation, &b_ev_rho_kt6PFJetsForIsolation);
   if(isData==false){
      ...
      {
         if(strstr(tmp_array->At(i)->GetName(),"mc_index"))
         {
...
//   set trigger for eff study
   ...
   if(true==isData){
      ...
      for(i = 0; i<tmp_array->GetEntries(); i++)
      {
         ...
         {
            cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_GsfTrkIdVL_accept included"<<endl;
         ...
         {
            cout<<"branch : trig_HLT_DoubleEle33_CaloIdL_MW_accept included"<<endl;
