...
////////////////////////////////////////////
   ...
   vector<float> *trig_L1_eta_1 ;
   vector<float> *trig_L1_eta_2 ;
   vector<float> *trig_L1_phi_1 ;
   vector<float> *trig_L1_phi_2 ;
...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   TBranch *b_trig_L1_eta_1 ;
   TBranch *b_trig_L1_eta_2 ;
   TBranch *b_trig_L1_phi_1 ;
   TBranch *b_trig_L1_phi_2 ;
...
#ifdef reskim_cxx
reskim::reskim(TTree *tree, bool isData_in, bool isZToTT_in, bool isWJets_in, bool isZToEE_in,  int triggerVersion_in, int runNo1_in, int runNo2_in) :
fChain(0),
goldenLumi(3512.0), 
silverLumi(0.0), 
combinedLumi(3512.0)
...
//
   if(true==isWJets || true==isZToTT || true==isZToEE){
