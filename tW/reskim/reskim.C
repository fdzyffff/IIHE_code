...
struct electron_candidate{
  ...
  electron_candidate(float pt_in, float gsf_eta_in, float gsf_phi_in, float eta_in, float phi_in, int charge_in){
    pt     = pt_in     ;
    eta    = eta_in    ;
    phi    = phi_in    ;
    gsf_eta    = gsf_eta_in    ;
    ...
    p4_sc.SetPtEtaPhiM(pt, eta, phi, m_el) ;
...
struct muon_candidate{
  ...
  muon_candidate(float pt_old_in, float pt_in, float eta_in, float phi_in, int charge_in){
    pt_old = pt_old_in ;
    pt     = pt_in     ;
    eta    = eta_in    ;
    phi    = phi_in    ;
...
void reskim::Loop(TString fname){
   ...
   tree_out.Branch("pass_step2"		,&pass_step2	,"pass_step2/I") ;
   tree_out.Branch("pass_step3"		,&pass_step3	,"pass_step3/I") ;
   tree_out.Branch("pass_step411"	,&pass_step411	,"pass_step411/I") ;
   tree_out.Branch("pass_step412"	,&pass_step412	,"pass_step412/I") ;
   tree_out.Branch("pass_step421"	,&pass_step421	,"pass_step421/I") ;
   tree_out.Branch("pass_step422"	,&pass_step422	,"pass_step422/I") ;
   tree_out.Branch("pass_step43"	,&pass_step43	,"pass_step43/I") ;
   tree_out.Branch("pass_step5"		,&pass_step5	,"pass_step5/I") ;
   ...
   tree_out.Branch("trig_Mu50_fire"		,&trig_Mu50_fire	,"trig_Mu50_fire/I");
   tree_out.Branch("trig_TkMu50_fire"		,&trig_TkMu50_fire	,"trig_TkMu50_fire/I");
   ...
   tree_out.Branch("trig_Mu22_fire"		,&trig_Mu22_fire	,"trig_Mu22_fire/I");
   tree_out.Branch("trig_TkMu22_fire"		,&trig_TkMu22_fire	,"trig_TkMu22_fire/I");
   tree_out.Branch("trig_Ele23_Ele12_fire"	,&trig_Ele23_Ele12_fire	,"trig_Ele23_Ele12_fire/I");
   tree_out.Branch("trig_Ele27_fire"		,&trig_Ele27_fire	,"trig_Ele27_fire/I");
   tree_out.Branch("trig_Ele25_fire"		,&trig_Ele25_fire	,"trig_Ele25_fire/I");
   tree_out.Branch("trig_Mu8_Ele23_fire"	,&trig_Mu8_Ele23_fire	,"trig_Mu8_Ele23_fire/I");
   tree_out.Branch("trig_Mu23_Ele12_fire"	,&trig_Mu23_Ele12_fire	,"trig_Mu23_Ele12_fire/I");
   tree_out.Branch("trig_Mu17_TkMu8_fire"	,&trig_Mu17_TkMu8_fire	,"trig_Mu17_TkMu8_fire/I");
   tree_out.Branch("trig_Mu17_Mu8_fire"		,&trig_Mu17_Mu8_fire	,"trig_Mu17_Mu8_fire/I");
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      ...
      if (isData)
      {
        pass_MET_filters = trig_Flag_goodVertices_accept && trig_Flag_globalTightHalo2016Filter_accept && trig_Flag_HBHENoiseFilter_accept && trig_Flag_HBHENoiseIsoFilter_accept && trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept && trig_Flag_eeBadScFilter_accept && trig_Flag_BadPFMuonFilter_accept && trig_Flag_BadChargedCandidateFilter_accept;
      }
      else
      {
        pass_MET_filters = trig_Flag_goodVertices_accept && trig_Flag_globalTightHalo2016Filter_accept && trig_Flag_HBHENoiseFilter_accept && trig_Flag_HBHENoiseIsoFilter_accept && trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept && trig_Flag_BadPFMuonFilter_accept && trig_Flag_BadChargedCandidateFilter_accept;
      }
      if (isPrint)
      {
          cout<<"################ MET #################"<<endl;
          cout<<"trig_Flag_goodVertices_accept : "<<trig_Flag_goodVertices_accept<<endl;
          cout<<"trig_Flag_globalTightHalo2016Filter_accept : "<<trig_Flag_globalTightHalo2016Filter_accept<<endl;
          ...
          cout<<"(not used) trig_Flag_METFilters_accept : "<<trig_Flag_METFilters_accept<<endl;
      ...
      if(isTTbar)
      {
        ...
        {
          if( (abs(LHE_pdgid->at(iMC)) == 6) )w_top = w_top*exp(0.0615-0.0005*LHE_Pt->at(iMC));
        }
        w_top = sqrt(w_top);
      }
      ...
      if(true==isData){
        ...
        w_PU_BCD       = w_sign*PU_reReco_Morind17::MC_pileup_weight(PU,0,"B2D");
        w_PU_EF       = w_sign*PU_reReco_Morind17::MC_pileup_weight(PU,0,"EF");
        w_PU_GH       = w_sign*PU_reReco_Morind17::MC_pileup_weight(PU,0,"GH");
      }
...
//          el->pass_trigger = trigEle27::passTrig(Et, eta) ;
        ...
        el->isTight = int(gsf80_Tight->at(iEl));
        ...
        if(isPrint)
        {
          ...
          cout<<"el sc eta :"<<el->eta<<endl;
          cout<<"el sc phi :"<<el->phi<<endl;
      ...
      if(pass_step1)
      {
      	if (((isEE || isMuMu) && MET_Et > 40) || isEMu)
      	{
      		pass_step3 = true;
      	}
      }
      ...
      //pass_global = pass_global && pass_step412;
      //start check pass421
      if (n_jet == 1)
      {
      	pass_step421 = true;
      }
      //pass_global = pass_global && pass_step421;
      //start check pass422
      if (n_bjet == 1)
      {
      	pass_step422 = true;
      ...
      pass_global = pass_global && ((pass_step411 && pass_step412) ||(pass_step421 && pass_step422) || pass_step43);
      //end check pass4
      //start check pass5
      pass_step5 = true;
      for (unsigned ijet = 0; ijet<jets.size(); ijet++)
      {
        ...
        if (jet->pt > 40 && (fabs(jet->eta)>2.4 && fabs(jet->eta)<5.2) && jet->isLoose && jet->p4.DeltaR(leading_lep->p4) > 0.4 && jet->p4.DeltaR(sub_leading_lep->p4) > 0.4)
        {
          pass_step5 = false;
          break;
        }
      }
      pass_global = pass_global && pass_step5;
      //end check pass5
      //check trigger
      if (isData)
      {
        if (ev_run < 276453 || 278822 < ev_run)
        {
          trig_DE33_fire = trig_DouEle33_MW_fire;
        }
        else
        {
          trig_DE33_fire = trig_DouEle33_fire;
        }
      }
      else
      {
        trig_DE33_fire = trig_DouEle33_MW_fire || trig_DouEle33_fire;
      }
