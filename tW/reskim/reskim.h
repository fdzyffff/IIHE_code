...
#ifdef reskim_cxx
reskim::reskim(TTree *tree, bool isData_in, bool isDY_in, bool isTTbar_in, bool isWW_in, ULong_t No_print_in, int triggerVersion_in, UInt_t runNo1_in, UInt_t runNo2_in)
{
