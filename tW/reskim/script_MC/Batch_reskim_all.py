...
"../MC/madgraph_DYToLL_10to50"           :[[False,False,False,False],[0]],
"../MC/madgraph_DYToLL_50"               :[[False,False,False,False],[0]],
"../MC/DYToLL_10to50"           :[[False,False,False,False],[0]],
"../MC/DYToLL_50"               :[[False,False,False,False],[0]],

"../MC/TTGJets"                 :[[False,False,True,False],[0]],
"../MC/TTTo2L2Nu"               :[[False,False,True,False],[0]],
"../MC/TTWJetsToLNu"            :[[False,False,True,False],[0]],
"../MC/TTWJetsToQQ"             :[[False,False,True,False],[0]],
"../MC/TTZToLLNuNu_10"          :[[False,False,True,False],[0]],
"../MC/TTZToQQ"                 :[[False,False,True,False],[0]],

"../MC/WGToLNuG"                :[[False,False,False,False],[0]],
"../MC/WJetsToLNu"              :[[False,False,False,False],[0]],
"../MC/WWTo2L2Nu"               :[[False,False,False,False],[0]],
"../MC/WZTo2L2Q"                :[[False,False,False,False],[0]],
"../MC/WZTo3LNu"                :[[False,False,False,False],[0]],
"../MC/ZZTo2L2Nu"               :[[False,False,False,False],[0]],
"../MC/ZZTo4L"                  :[[False,False,False,False],[0]],
"../MC/tW"                      :[[False,False,False,False],[0]],
"../MC/tW_anti"                 :[[False,False,False,False],[0]],
}
reskim_dic={
}
    ...
    for reskim in reskim_dic:
        ...
        for root_file in reskim_dic[reskim][1]:
            ...
            if (not isCheck) or (not output_name in reskim_dic[reskim][3]):
                ...
                job_text+=("python reskim_all.py -r %s -o %s --isData %s --isDY %s --isTTbin %s --isWWbin %s -t %s\n"%(root_file, output_name, isData, isDY, isTTbin, isWWbin, triggerVersion))
                n_job+=1
            i+=1
