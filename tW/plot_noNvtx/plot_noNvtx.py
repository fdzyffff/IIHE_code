...
def Fill_hist(sample_dic, value_dic, cut):
	...
	for event in t1:
		...
		for path in value_dic:
			...
			event_weight = leading_SF_weight * sub_leading_SF_weight * pu_weight * fake_weight * Nvtx_weight
...
'_noNvtx_EE_80_1b':["ee",""],
'_MuMu_80':["#mu#mu",""],
'_EMu_80_step2':["e#mu","event selection step 2"],
'_noNvtx_EE_80_1b_step2':["ee","event selection step 2"],
'_MuMu_80_step2':["#mu#mu","event selection step 2"],
...
'_noNvtx_EE_80':'getattr(event,"isEE") and getattr(event,"pass_trigger_EE") and getattr(event,"pass_step1")',
#'_noNvtx_EE_80_1b':'getattr(event,"isEE") and getattr(event,"pass_trigger_EE") and getattr(event,"pass_step1") and getattr(event,"n_bjet") == 1',
#'_MuMu_80':'getattr(event,"isMuMu") and getattr(event,"pass_trigger_MuMu") and getattr(event,"pass_step1")',
#'_EMu_80_step2':'getattr(event,"isEMu") and getattr(event,"pass_trigger_EMu") and getattr(event,"pass_step1") and (getattr(event,"M_ll") >= 80 or getattr(event, "MET_T1Txy_significance") >= 4)',
#'_noNvtx_EE_80_1b_step2':'getattr(event,"isEE") and getattr(event,"pass_trigger_EE") and getattr(event,"pass_step1") and (getattr(event,"M_ll") < 81 or getattr(event,"M_ll") > 101) and getattr(event,"MET_T1Txy_significance")>=4 and getattr(event,"n_bjet") == 1',
#'_MuMu_80_step2':'getattr(event,"isMuMu") and getattr(event,"pass_trigger_MuMu") and getattr(event,"pass_step1") and (getattr(event,"M_ll") < 81 or getattr(event,"M_ll") > 101) and getattr(event,"MET_T1Txy_significance") >=4',
...
dic_Nvtx			= Load_json("SF_EE_80/SF_EE_80_hratio_pv_n.json")
