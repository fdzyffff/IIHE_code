...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    // check MET filters
   if(Find_branch(fChain, "trig_Flag_goodVertices_accept")) {
      fChain->SetBranchAddress("trig_Flag_goodVertices_accept", &trig_Flag_goodVertices_accept, &b_trig_Flag_goodVertices_accept);
   }
   if(Find_branch(fChain, "trig_Flag_globalSuperTightHalo2016Filter_accept")) {
   ...
   if(Find_branch(fChain, "trig_Flag_HBHENoiseFilter_accept")) {
   ...
   if(Find_branch(fChain, "trig_Flag_HBHENoiseIsoFilter_accept")) {
   ...
   if(Find_branch(fChain, "trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept")) {
   ...
   if(Find_branch(fChain, "trig_Flag_BadPFMuonFilter_accept")) {
   ...
   if(Find_branch(fChain, "trig_Flag_ecalBadCalibReduced")) {
    ...
    if (isPrint)
    {
      ...
      cout<<"trig_Flag_ecalBadCalibReduced (been rerun locally) : "<<trig_Flag_ecalBadCalibReduced<<endl;
