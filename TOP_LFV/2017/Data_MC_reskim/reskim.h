...
//   fChain->SetBranchAddress("pv_totTrackSize", &pv_totTrackSize, &b_pv_totTrackSize);
   ...
   fChain->SetBranchAddress("gsf_VID_cutBasedElectronID_Fall17_94X_V1_loose",  &gsf_Loose,  &b_gsf_Loose);
   fChain->SetBranchAddress("gsf_VID_cutBasedElectronID_Fall17_94X_V1_medium",  &gsf_Medium,  &b_gsf_Medium);
   fChain->SetBranchAddress("gsf_VID_cutBasedElectronID_Fall17_94X_V1_tight",  &gsf_Tight,  &b_gsf_Tight);
...
*/
   if(false==isData){
	...
	if(Find_branch(fChain, "trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept"))
	{
	...
	} else if (Find_branch(fChain, "trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept")) {
      ...
      cout<<"Instead : trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept"<<endl;
   }
...
/*
   ...
   fChain->SetBranchAddress("jet_isJetIDLepVeto_2017", &jet_isJetIDLepVeto, &b_jet_isJetIDLepVeto) ;
