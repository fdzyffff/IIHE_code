...
if options.p_number > 0:
    tmp_reskim = ROOT.reskim(tmp_chain, isData , isDY, isTTbin, isWWbin, options.p_number, options.mc_str)
else: 
    tmp_reskim = ROOT.reskim(tmp_chain, isData , isDY, isTTbin, isWWbin, 0, options.mc_str)
