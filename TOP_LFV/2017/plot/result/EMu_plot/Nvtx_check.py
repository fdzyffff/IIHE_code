...
def get_plot(input_0b_data, input_1b_before, input_1b_after, out_dir, label):
...
for plot in plot_dic:
	get_plot(plot_dic[plot][0],plot_dic[plot][1],plot_dic[plot][2],plot_dic[plot][3],plot_dic[plot][4])