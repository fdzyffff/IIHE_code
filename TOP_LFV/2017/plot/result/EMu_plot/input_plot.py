...
def map_value(path, event, h1, tmp_value_dic, event_weight_factor):
	...
	if path == "new_leading_pt" or path == "new_sub_leading_pt" or path == "new_leading_pt_muon" or path == "new_sub_leading_pt_muon" or path == "new_leading_pt_ele" or path == "new_sub_leading_pt_ele":
		...
		if n_jet == 1 and n_bjet == 0:
			h1.Fill(n_jet_bjet_dic2["(1,0)"][0],event_weight_factor)
		if n_jet == 1 and n_bjet == 1:
			h1.Fill(n_jet_bjet_dic2["(1,1)"][0],event_weight_factor)
		if n_jet == 2 and n_bjet == 1:
			h1.Fill(n_jet_bjet_dic2["(2,1)"][0],event_weight_factor)
		if n_jet == 3 and n_bjet == 1:
			h1.Fill(n_jet_bjet_dic2["(>=3,1)"][0],event_weight_factor)
		if n_jet == 3 and n_bjet > 1:
			h1.Fill(n_jet_bjet_dic2["(>=3,>1)"][0],event_weight_factor)
		...
		if leading_jet_id >= 0:
			...
			h1.Fill(tmp_value,event_weight_factor)
		...
		if getattr(event,"MET_FinalCollection_Pt") < 80:
			h1.Fill(getattr(event,"MET_FinalCollection_Pt"),event_weight_factor)
		else:
			h1.Fill(79.0,event_weight_factor)
...
"MET_pt_new":{
                ...
                "MC_value_dic":{"MET_FinalCollection_Pt":True},
                                "hist_name":"MET_Pt_new",
                                "hist_title":"MET Pt",
                                "use_array":False,
                                "PU_reweight":True,
                                "hist_para":[20,x_emu_new,0,80],
                                "y_axis":["null","null"],
                                "x_label":['MET (GeV/c)',0.1],
                                "y_label":['Event / 4 GeV',0.05],
                                "x_log":False,
                                "y_log":False,
                                "lenend":{
                                "useLegend":True,
...
"n_jet_bjet":{
		...
		"MC_value_dic":{"":True},
				...
				"use_array":False,
				"PU_reweight":True,
				"hist_para":[len(n_jet_bjet_dic),x_emu_new,0,len(n_jet_bjet_dic)],
				"y_axis":["null","null"],
...
"n_jet_bjet2":{
		...
		"MC_value_dic":{"":True},
				...
				"use_array":False,
				"PU_reweight":True,
				"hist_para":[len(n_jet_bjet_dic2),x_emu_new,0,len(n_jet_bjet_dic2)],
				"y_axis":["null","null"],
				"x_label":['N_{(jet, b jet)}',0.1],
				"y_label":['Event / 1',0.05],
				"x_log":False,
