import ROOT
import os
from global_dep import *

split_dic = {
}

root_dir_dic ={
"rB_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runB/",[]],
"rC_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runC/",[]],
"rD_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runD/",[]],
"rE_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runE/",[]],
"rF_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runF/",[]],
"rG_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runG/",[]],
"rH_1" : ["/pnfs/iihe/cms/store/user/xgao/samples-20191203/data/2016/MuonEG/crab_MuonEG_runH/",[]],
}
...
def setlink(branch_name, filelist):
    ...
    sub_dir_ori = "0000"
    sub_dir = "0000"
    print "link setting : %s (%d files)"%(branch_name, len(root_dir_dic[branch_name][1]))
    process_bar = ShowProcess(len(root_dir_dic[branch_name][1]))
