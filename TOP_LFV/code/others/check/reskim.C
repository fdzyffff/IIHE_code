...
//        }
      muon_candidate* mu = new muon_candidate(pt, pt, eta, phi, charge) ;
...
//          el->pass_trigger = trigEle27::passTrig(Et, eta) ;
    ...
    //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    if (isEE && (trig_Ele23_Ele12_fire) ) {
      pass_trigger_EE = true;
    }
    if (isEMu && (trig_Mu8_Ele23_fire || trig_Mu23_Ele12_fire) ) {
      pass_trigger_EMu = true;
    }
    if (isMuMu && (trig_Mu17_Mu8_fire) ) {
      pass_trigger_MuMu = true;
    }
    if(isEE && (pass_trigger_EE || trig_Ele35_fire) ) {
      pass_trigger_EE_step2 = true;
    }
    if(isEMu && (pass_trigger_EMu || trig_Ele35_fire || trig_Mu27_fire) ) {
      pass_trigger_EMu_step2 = true;
    }
    if(isMuMu && (pass_trigger_MuMu || trig_Mu27_fire) ) {
      pass_trigger_MuMu_step2 = true;
    }
    //end trigger
    //start store info
    if (pass_step1)
