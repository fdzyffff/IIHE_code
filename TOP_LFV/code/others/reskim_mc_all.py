...
parser.add_option("-e","--isWW",dest="isWW",default="",type="str")
...
#reskim(TTree *tree=0, bool isData_in=false, bool isZToTT_in=false, bool isWJets_in=false, bool isWW_in=false, int triggerVersion_in=0, int runNo1_in=0, int runNo2_in=0);
...
isWW = True if options.isWW == "1" else False
print "isData: ",isData
print "isZToTT: ",isZToTT
print "isWJets: ",isWJets
print "isWW: ",isWW
tmp_reskim = ROOT.reskim(tmp_chain,  isData, isZToTT, isWJets, isWW)
