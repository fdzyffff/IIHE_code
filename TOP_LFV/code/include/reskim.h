...
////////////////////////////////////////////
   ...
   UInt_t trig_Mu27_fire;
   UInt_t trig_Mu24_fire;
   UInt_t trig_TkMu24_fire;
   UInt_t trig_Ele27_fire;
   UInt_t trig_Ele32_fire;
   UInt_t trig_Ele35_fire;
   UInt_t trig_Mu8_Ele23_fire;
   UInt_t trig_Mu23_Ele12_fire;
   UInt_t trig_Mu8_Ele23_DZ_fire;
   UInt_t trig_Mu23_Ele12_DZ_fire;
   UInt_t trig_Ele23_Ele12_fire;
   UInt_t trig_Mu17_TkMu8_fire;
   UInt_t trig_Mu17_Mu8_fire;
   ...
   UInt_t trig_Flag_ecalBadCalibReduced;
...
//Jet
   ...
   float jet_BtagSF_loose ;
   float jet_BtagSF_medium ;
   float jet_BtagSF_tight ;

   vector<int> *jet_isJetID ;
   vector<int> *jet_isJetIDLepVeto ;
...
//   TBranch        *b_MET_caloMet_phi;   //!
   ...
   virtual bool     Find_branch(TString branch_name);
   virtual bool     Find_and_set_branch(TString branch_name, UInt_t &input_value, TBranch *input_branch);
};
...
bool reskim::Find_branch(TString branch_name) {
	int i = 0;
...
bool reskim::Find_and_set_branch(TString branch_name, UInt_t &input_value, TBranch *input_branch) {
   int i = 0;
   TObjArray *tmp_array = fChain->GetListOfBranches();
   for(i = 0; i<tmp_array->GetEntries(); i++)
   { 
      if(strstr(tmp_array->At(i)->GetName(), branch_name))
         fChain->SetBranchAddress(branch_name, &input_value, &input_branch);
         return true;
   }
   cout<<"Branch : "<<branch_name<<" set failed"<<endl;
   return false;
...
void reskim::Init(TTree *tree)
{
   ...
   cout<<"Info isDY  :  "<<isDY<<endl;
   cout<<"Info isTTbar  :  "<<isTTbar<<endl;
   cout<<"Info isWW  :  "<<isWW<<endl;
   cout<<"Info No_print  :  "<<No_print<<endl;
   cout<<"Info mc_str  :  "<<mc_str<<endl;
   cout<<"Info sys_str  :  "<<sys_str<<endl;
   ...
   MET_FinalCollection_Pt = 0;
   MET_FinalCollection_Px = 0;
   MET_FinalCollection_Py = 0;
   MET_FinalCollection_phi = 0;
   MET_FinalCollection_significance = 0;
   HEEP_eseffsixix = 0;
   HEEP_eseffsiyiy = 0;
   HEEP_eseffsirir = 0;
   ...
   trig_Mu8_Ele23_DZ_fire = 0;
   trig_Mu23_Ele12_DZ_fire = 0;
   ...
   trig_Flag_ecalBadCalibReduced = 0 ;
...
//   fChain->SetBranchAddress("ev_rho_kt6PFJetsForIsolation", &ev_rho_kt6PFJetsForIsolation, &b_ev_rho_kt6PFJetsForIsolation);
   if(isData==false){
       if(Find_branch("ev_prefiringweight") ) {fChain->SetBranchAddress("ev_prefiringweight", &ev_prefiringweight, &b_ev_prefiringweight);}
       if(Find_branch("ev_prefiringweightup") ) {fChain->SetBranchAddress("ev_prefiringweightup", &ev_prefiringweightup, &b_ev_prefiringweightup);}
       if(Find_branch("ev_prefiringweightdown") ) {fChain->SetBranchAddress("ev_prefiringweightdown", &ev_prefiringweightdown, &b_ev_prefiringweightdown);}
...
//   fChain->SetBranchAddress("pv_totTrackSize", &pv_totTrackSize, &b_pv_totTrackSize);
   ...
   fChain->SetBranchAddress("gsf_VID_cutBasedElectronID_Fall17_94X_V2_loose",  &gsf_Loose,  &b_gsf_Loose);
   fChain->SetBranchAddress("gsf_VID_cutBasedElectronID_Fall17_94X_V2_medium",  &gsf_Medium,  &b_gsf_Medium);
   fChain->SetBranchAddress("gsf_VID_cutBasedElectronID_Fall17_94X_V2_tight",  &gsf_Tight,  &b_gsf_Tight);
...
//for muon:
   ...
   if (Find_branch("trig_Flag_goodVertices_accept") ) fChain->SetBranchAddress("trig_Flag_goodVertices_accept", &trig_Flag_goodVertices_accept, &b_trig_Flag_goodVertices_accept);
   if (Find_branch("trig_Flag_globalSuperTightHalo2016Filter_accept") ) fChain->SetBranchAddress("trig_Flag_globalSuperTightHalo2016Filter_accept", &trig_Flag_globalSuperTightHalo2016Filter_accept, &b_trig_Flag_globalSuperTightHalo2016Filter_accept);
   if (Find_branch("trig_Flag_HBHENoiseFilter_accept") ) fChain->SetBranchAddress("trig_Flag_HBHENoiseFilter_accept", &trig_Flag_HBHENoiseFilter_accept, &b_trig_Flag_HBHENoiseFilter_accept);
   if (Find_branch("trig_Flag_HBHENoiseIsoFilter_accept") ) fChain->SetBranchAddress("trig_Flag_HBHENoiseIsoFilter_accept", &trig_Flag_HBHENoiseIsoFilter_accept, &b_trig_Flag_HBHENoiseIsoFilter_accept);
   if (Find_branch("trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept") ) fChain->SetBranchAddress("trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept", &trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept, &b_trig_Flag_EcalDeadCellTriggerPrimitiveFilter_accept);
   if (Find_branch("trig_Flag_BadPFMuonFilter_accept") ) fChain->SetBranchAddress("trig_Flag_BadPFMuonFilter_accept", &trig_Flag_BadPFMuonFilter_accept, &b_trig_Flag_BadPFMuonFilter_accept);
   if (Find_branch("trig_Flag_eeBadScFilter_accept") ) fChain->SetBranchAddress("trig_Flag_eeBadScFilter_accept", &trig_Flag_eeBadScFilter_accept, &b_trig_Flag_eeBadScFilter_accept);
   if (Find_branch("trig_Flag_ecalBadCalibReduced") ) fChain->SetBranchAddress("trig_Flag_ecalBadCalibReduced", &trig_Flag_ecalBadCalibReduced, &b_trig_Flag_ecalBadCalibReduced);
   if (Find_branch("trig_Flag_BadChargedCandidateFilter_accept") ) fChain->SetBranchAddress("trig_Flag_BadChargedCandidateFilter_accept", &trig_Flag_BadChargedCandidateFilter_accept, &b_trig_Flag_BadChargedCandidateFilter_accept);

   if(false==isData){ cout<<"is MC, use triggers"<<endl ;}
   if (year == "2016") {
      cout<<"Trig year  :  "<<year<<endl;
      if (Find_branch("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_accept") )fChain->SetBranchAddress("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_accept" , &trig_Mu8_Ele23_fire ,  &b_trig_Mu8_Ele23_fire ) ;
      if (Find_branch("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept") )fChain->SetBranchAddress("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept" , &trig_Mu8_Ele23_DZ_fire ,  &b_trig_Mu8_Ele23_DZ_fire ) ;
      if (Find_branch("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept") )fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept", &trig_Mu23_Ele12_fire,  &b_trig_Mu23_Ele12_fire) ;
      if (Find_branch("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept") )fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept", &trig_Mu23_Ele12_DZ_fire,  &b_trig_Mu23_Ele12_DZ_fire) ;
      if (Find_branch("trig_HLT_Ele27_WPTight_Gsf_accept") )fChain->SetBranchAddress("trig_HLT_Ele27_WPTight_Gsf_accept"    , &trig_Ele27_fire         , &b_trig_Ele27_fire ) ;  
      if (Find_branch("trig_HLT_IsoMu24_accept") )fChain->SetBranchAddress("trig_HLT_IsoMu24_accept"    , &trig_Mu24_fire, &b_trig_Mu24_fire ) ;
      if (Find_branch("trig_HLT_IsoTkMu24_accept") )fChain->SetBranchAddress("trig_HLT_IsoTkMu24_accept"    , &trig_TkMu24_fire, &b_trig_TkMu24_fire ) ;
   }
   if (year == "2017") {
      cout<<"Trig year  :  "<<year<<endl;
      if (Find_branch("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept") )fChain->SetBranchAddress("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept" , &trig_Mu8_Ele23_DZ_fire ,  &b_trig_Mu8_Ele23_DZ_fire ) ;
      if (Find_branch("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept") )fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept", &trig_Mu23_Ele12_fire,  &b_trig_Mu23_Ele12_fire) ;
      if (Find_branch("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept") )fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_DZ_accept", &trig_Mu23_Ele12_DZ_fire,  &b_trig_Mu23_Ele12_DZ_fire) ;
      if (Find_branch("trig_HLT_Ele35_WPTight_Gsf_accept") )fChain->SetBranchAddress("trig_HLT_Ele35_WPTight_Gsf_accept"    , &trig_Ele35_fire         , &b_trig_Ele35_fire ) ;
      if (Find_branch("trig_HLT_IsoMu27_accept") )fChain->SetBranchAddress("trig_HLT_IsoMu27_accept"    , &trig_Mu27_fire, &b_trig_Mu27_fire ) ;
   }   
   if (year == "2018") {
      cout<<"Trig year  :  "<<year<<endl;
      if (Find_branch("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept") )fChain->SetBranchAddress("trig_HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_DZ_accept" , &trig_Mu8_Ele23_DZ_fire ,  &b_trig_Mu8_Ele23_DZ_fire ) ;
      if (Find_branch("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept") )fChain->SetBranchAddress("trig_HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_accept", &trig_Mu23_Ele12_fire,  &b_trig_Mu23_Ele12_fire) ;
      if (Find_branch("trig_HLT_Ele32_WPTight_Gsf_accept") )fChain->SetBranchAddress("trig_HLT_Ele32_WPTight_Gsf_accept"    , &trig_Ele32_fire         , &b_trig_Ele32_fire ) ;
      if (Find_branch("trig_HLT_IsoMu24_accept") )fChain->SetBranchAddress("trig_HLT_IsoMu24_accept"    , &trig_Mu24_fire, &b_trig_Mu24_fire ) ;
   }
   ...
   if (isData) {
      ...
      fChain->SetBranchAddress("jet_energy", &jet_energy, &b_jet_energy)  ;
      fChain->SetBranchAddress("BtagSF_Deepcsv_loose", &jet_BtagSF_loose, &b_jet_BtagSF_loose)  ;
      fChain->SetBranchAddress("BtagSF_Deepcsv_medium", &jet_BtagSF_medium, &b_jet_BtagSF_medium)  ;
      fChain->SetBranchAddress("BtagSF_Deepcsv_tight", &jet_BtagSF_tight, &b_jet_BtagSF_tight)  ;
   }
   ...
   fChain->SetBranchAddress("jet_isJetIDLoose_2016", &jet_isJetID, &b_jet_isJetID) ;
   fChain->SetBranchAddress("jet_isJetIDTightLepVeto_2016", &jet_isJetIDLepVeto, &b_jet_isJetIDLepVeto) ;
